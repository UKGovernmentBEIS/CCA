...
export class MiReportsSystemService {
   ...
   */
  public generateReport(miReportSystemParams: MiReportSystemParams): Observable<MiReportSystemResult>;
  ...
  public generateReport(
    ...
    return this.httpClient.post<MiReportSystemResult>(
      `${this.configuration.basePath}/v1.0/mireports/system`,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getCurrentUserMiReports(): Observable<MiReportSystemSearchResult[]>;
  public getCurrentUserMiReports(
    observe: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<HttpResponse<MiReportSystemSearchResult[]>>;
  public getCurrentUserMiReports(
    observe: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<HttpEvent<MiReportSystemSearchResult[]>>;
  public getCurrentUserMiReports(
    observe: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' },
  ): Observable<MiReportSystemSearchResult[]>;
  public getCurrentUserMiReports(
    observe: any = 'body',
    reportProgress = false,
    options?: { httpHeaderAccept?: 'application/json' },
    ...
    return this.httpClient.get<MiReportSystemSearchResult[]>(
      `${this.configuration.basePath}/v1.0/mireports/system/types`,
      {
        responseType: responseType_ as any,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public getRegulatorRequestTaskTypes(
    ...
    return this.httpClient.get<string[]>(`${this.configuration.basePath}/v1.0/mireports/system/request-task-types`, {
      responseType: responseType_ as any,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
