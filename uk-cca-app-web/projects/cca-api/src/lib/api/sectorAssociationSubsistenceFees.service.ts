...
export class SectorAssociationSubsistenceFeesService {
  ...
  /**
   * Retrieves the subsistence fees MoAs for the specified sector
   * @param sectorAssociationId The sectorAssociationId
   * @param subsistenceFeesMoaSearchCriteria
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSectorSubsistenceFeesMoas(
  ...
  public getSectorSubsistenceFeesMoas(
    ...
    if (sectorAssociationId === null || sectorAssociationId === undefined) {
      throw new Error(
        'Required parameter sectorAssociationId was null or undefined when calling getSectorSubsistenceFeesMoas.',
      );
    }
    if (subsistenceFeesMoaSearchCriteria === null || subsistenceFeesMoaSearchCriteria === undefined) {
      throw new Error(
        'Required parameter subsistenceFeesMoaSearchCriteria was null or undefined when calling getSectorSubsistenceFeesMoas.',
      );
    }
    ...
    return this.httpClient.post<SubsistenceFeesMoaSearchResults>(
      `${this.configuration.basePath}/v1.0/sector-association/${encodeURIComponent(String(sectorAssociationId))}/subsistence-fees/moas`,
