...
export class DocumentTemplatesService {
   ...
   */
  public getCurrentUserDocumentTemplates(page: number, size: number, term?: string): Observable<TemplateSearchResults>;
  ...
  public getCurrentUserDocumentTemplates(
    ...
    return this.httpClient.get<TemplateSearchResults>(`${this.configuration.basePath}/v1.0/document-templates`, {
