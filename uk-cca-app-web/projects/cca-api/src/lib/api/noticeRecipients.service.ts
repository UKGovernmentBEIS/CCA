...
export class NoticeRecipientsService {
  ...
  /**
   * Retrieves the additional Operators and the Sector users
   * @param accountId The target unit account id
  ...
  public getAdditionalNoticeRecipients(
    ...
    if (accountId === null || accountId === undefined) {
      throw new Error('Required parameter accountId was null or undefined when calling getAdditionalNoticeRecipients.');
    }
