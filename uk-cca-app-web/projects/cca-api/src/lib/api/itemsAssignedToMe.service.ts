...
export class ItemsAssignedToMeService {
   ...
   */
  public getAssignedItems(page: number, size: number): Observable<ItemDTOResponse>;
  ...
  public getAssignedItems(
    ...
    return this.httpClient.get<ItemDTOResponse>(`${this.configuration.basePath}/v1.0/items/assigned-to-me`, {
