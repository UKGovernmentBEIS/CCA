...
export class FileEvidencesUploadService {
   ...
   */
  public uploadEvidenceFile(file: Blob): Observable<FileUuidDTO>;
  ...
  public uploadEvidenceFile(
    ...
    if (file === null || file === undefined) {
      throw new Error('Required parameter file was null or undefined when calling uploadEvidenceFile.');
    }
    ...
    return this.httpClient.post<FileUuidDTO>(
      `${this.configuration.basePath}/v1.0/file-evidence/upload`,
