...
export class SectorAssociationTargetUnitAccountsInfoService {
  ...
  /**
   * Retrieves the target unit accounts and their contacts for specified sector
  ...
  public getTargetUnitAccountsWithSiteContacts(
    ...
    return this.httpClient.get<TargetUnitAccountInfoResponseDTO>(
      `${this.configuration.basePath}/v1.0/sector-association/${encodeURIComponent(String(sectorId))}/target-unit-accounts/`,
      {
  ...
  /**
   * Updates target unit account site contacts for specified sector
   * @param sectorId The sector association id
   * @param targetUnitAccountSiteContactDTO
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  ...
  public updateTargetUnitAccountSiteContacts(
    ...
    if (sectorId === null || sectorId === undefined) {
      throw new Error(
        'Required parameter sectorId was null or undefined when calling updateTargetUnitAccountSiteContacts.',
      );
    }
    if (targetUnitAccountSiteContactDTO === null || targetUnitAccountSiteContactDTO === undefined) {
      throw new Error(
        'Required parameter targetUnitAccountSiteContactDTO was null or undefined when calling updateTargetUnitAccountSiteContacts.',
      );
    }
