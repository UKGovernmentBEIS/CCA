...
export class SectorUsersInvitationService {
  ...
  /**
   * Adds a new sector user to a sector association with a specified role.
   * @param sectorAssociationId The sector association id
   * @param sectorUserInvitationDTO
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public inviteUserToSectorAssociation(
  ...
  public inviteUserToSectorAssociation(
    ...
    if (sectorAssociationId === null || sectorAssociationId === undefined) {
      throw new Error(
        'Required parameter sectorAssociationId was null or undefined when calling inviteUserToSectorAssociation.',
      );
    }
    if (sectorUserInvitationDTO === null || sectorUserInvitationDTO === undefined) {
      throw new Error(
        'Required parameter sectorUserInvitationDTO was null or undefined when calling inviteUserToSectorAssociation.',
      );
    }
