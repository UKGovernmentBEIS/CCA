...
export class CcaRequestsService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public processCcaRequestCreateAction(
  ...
  public processCcaRequestCreateAction(
    ...
    if (sectorAssociationId === null || sectorAssociationId === undefined) {
      throw new Error(
        'Required parameter sectorAssociationId was null or undefined when calling processCcaRequestCreateAction.',
      );
    }
    if (requestCreateActionProcessDTO === null || requestCreateActionProcessDTO === undefined) {
      throw new Error(
        'Required parameter requestCreateActionProcessDTO was null or undefined when calling processCcaRequestCreateAction.',
      );
    }
    ...
    return this.httpClient.post<RequestCreateActionProcessResponseDTO>(
      `${this.configuration.basePath}/v1.0/cca-requests`,
