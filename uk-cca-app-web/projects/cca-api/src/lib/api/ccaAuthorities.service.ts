...
export class CcaAuthoritiesService {
  ...
  /**
   * Retrieves the sector user roles
  ...
  public getSectorUserRoles(
    ...
    if (sectorId === null || sectorId === undefined) {
      throw new Error('Required parameter sectorId was null or undefined when calling getSectorUserRoles.');
    }
