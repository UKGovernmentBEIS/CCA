...
export class TimelineItemLinkPipe implements PipeTransform {
  transform(value: RequestActionInfoDTO, isWorkflow?: boolean): any[] {
    ...
    switch (value.type) {
      ...
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_SUBMITTED':
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_COMPLETED':
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_ACTIVATED':
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEWER_ACCEPTED':
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEWER_REJECTED':
      case 'CCA2_TERMINATION_ACCOUNT_PROCESSING_SUBMITTED':
      case 'NON_COMPLIANCE_DETAILS_SUBMITTED':
      case 'NON_COMPLIANCE_NOTICE_OF_INTENT_SUBMITTED':
      case 'NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_SUBMITTED':
      case 'NON_COMPLIANCE_NOTICE_OF_INTENT_PEER_REVIEWER_ACCEPTED':
      case 'NON_COMPLIANCE_NOTICE_OF_INTENT_PEER_REVIEWER_REJECTED':
      case 'NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_PEER_REVIEWER_ACCEPTED':
      case 'NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_PEER_REVIEWER_REJECTED':
      case 'NON_COMPLIANCE_CONCLUSION_SUBMITTED':
      case 'NON_COMPLIANCE_APPEAL_PROVIDED':
      ...
      case 'UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEW_REQUESTED':
