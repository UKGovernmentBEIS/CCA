...
import { WorkflowHistoryTabState } from '../../workflow-history-tab/workflow-history-tab.types';
import { workflowStatusesMap, workflowTypesMap } from './workflow-history-tab.types';
import {
      ...
      .pipe(
        ...
        switchMap((queryParamMap) => {
          ...
          const requestSearchCriteria: RequestSearchCriteria = {
            ...
            resourceId: this.facilityId,
            requestTypes,
            requestStatuses,
            historyCategory: HistoryCategory.FACILITY,
            pageNumber: page - 1,
            pageSize,
          };
