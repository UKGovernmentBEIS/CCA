...
export class ToggleLockComponent {
  ...
  protected readonly isTargetUnitLocked = this.performanceReportStore.state.statusInfo.locked;

  protected readonly legendText = this.isTargetUnitLocked
    ? 'Do you wish to unlock the performance reporting task?'
    : 'Do you want to lock the performance reporting task?';

  protected readonly hint = this.isTargetUnitLocked
