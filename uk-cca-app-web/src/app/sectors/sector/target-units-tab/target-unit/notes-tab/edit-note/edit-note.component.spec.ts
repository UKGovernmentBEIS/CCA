...
describe('EditNoteComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockAccountNotesService.updateAccountNote = jest.fn().mockReturnValue(of({}));
    ...
    const mockActivatedRoute = new ActivatedRouteStub({ targetUnitId: '123', noteId: '1' });
  ...
  it('should not submit if form is invalid', () => {
    ...
    expect(accountNotesService.updateAccountNote).not.toHaveBeenCalled();
  });
  ...
  it('should submit valid form and navigate back', () => {
    ...
    expect(accountNotesService.updateAccountNote).toHaveBeenCalledWith(1, {
      note: updatedNote,
      files: ['uuid-1'],
    });
  ...
  it('should handle empty files array', () => {
    ...
    expect(accountNotesService.updateAccountNote).toHaveBeenCalledWith(
      1,
