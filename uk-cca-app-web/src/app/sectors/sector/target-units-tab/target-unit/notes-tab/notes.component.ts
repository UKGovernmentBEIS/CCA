...
export class NotesComponent {
  ...
  readonly currentPage = computed(() => {
    ...
    return +params?.get('page') || NotesComponent.DEFAULT_PAGE;
  });

  readonly pageSize = computed(() => {
    const params = this.queryParams();
    return +params?.get('pageSize') || NotesComponent.DEFAULT_PAGE_SIZE;
  });
    ...
    this.activatedRoute.queryParamMap
      .pipe(
        ...
        switchMap((queryParamMap) => {
          const page = +queryParamMap.get('page') || NotesComponent.DEFAULT_PAGE;
          const pageSize = +queryParamMap.get('pageSize') || NotesComponent.DEFAULT_PAGE_SIZE;
