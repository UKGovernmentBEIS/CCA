...
import { ButtonDirective, GovukTableColumn, SortEvent, TableComponent } from 'govuk-components';
...
@Component({
  ...
  standalone: true,
  imports: [AsyncPipe, NgSwitch, NgSwitchCase, NgIf, NgSwitchDefault, RouterLink, ButtonDirective, TableComponent],
})
