...
import { DocumentTemplatesService, NotificationTemplatesService, TemplateSearchResults } from 'cca-api';
...
describe('TemplatesComponent', () => {
  ...
  describe('for non empty results', () => {
    ...
    it('should render operator documents', () => {
      ...
      expect(documentTemplatesService.getCurrentUserDocumentTemplates).toHaveBeenLastCalledWith(0, 30, null);
      ...
      expect(documentTemplatesService.getCurrentUserDocumentTemplates).toHaveBeenLastCalledWith(0, 30, 'ref');
    });
  });
});
