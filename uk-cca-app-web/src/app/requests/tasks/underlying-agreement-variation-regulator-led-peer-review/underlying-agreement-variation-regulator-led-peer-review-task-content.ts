...
import { UnARegulatorLedVariationPeerReviewPrecontentComponent } from './precontent/underlying-agreement-variation-peer-review-precontent.component';

const routePrefix = 'underlying-agreement-variation-regulator-led-peer-review';

export const unaRegulatorLedVariationPeerReviewTaskContent: RequestTaskPageContentFactory = () => {
  const store = inject(RequestTaskStore);
  const payload = store.select(requestTaskQuery.selectRequestTaskPayload)();

  return {
    header: 'Peer review of underlying agreement variation',
    preContentComponent: UnARegulatorLedVariationPeerReviewPrecontentComponent,
    sections: getAllUnARegulatorLedVariationPeerReviewSections(payload),
  };
};

export function getAllUnARegulatorLedVariationPeerReviewSections(
