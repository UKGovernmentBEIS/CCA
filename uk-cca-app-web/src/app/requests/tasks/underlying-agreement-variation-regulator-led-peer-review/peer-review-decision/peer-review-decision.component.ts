...
import {
  UnARegulatorLedVariationPeerReviewState,
  UnARegulatorLedVariationPeerReviewStore,
} from '../+state/underlying-agreement-variation-regulator-led-peer-review.store';
import {
...
export class PeerReviewDecisionComponent {
  ...
  onSubmit() {
    ...
    const statePayload: UnARegulatorLedVariationPeerReviewState = {
      decision: {
