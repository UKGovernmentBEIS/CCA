...
@Component({
  selector: 'cca-underlying-agreement-variation-regulator-led-peer-review-precontent',
  template: `
    @if (isUserAssignee()) {
      <button
        netzPendingButton
        govukButton
        type="button"
        routerLink="underlying-agreement-variation-regulator-led-peer-review/peer-review-decision"
...
export class UnARegulatorLedVariationPeerReviewPrecontentComponent {
