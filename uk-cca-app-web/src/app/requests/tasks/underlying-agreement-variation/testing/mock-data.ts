...
const facilitiesOriginal: Facility[] = [
  ...
  {
    facilityId: 'ADS_1-F00005',
    status: 'LIVE',
    facilityDetails: {
      name: 'Original Facility 5',
      facilityAddress: {
        city: 'Facility City',
        line1: 'Facility Line1',
        line2: 'Facility Line2',
...
export const mockMalformedUnderlyingAgreementVariation = {
  ...mockUnderlyingAgreementVariation,
  facilities: undefined,
  underlyingAgreementVariationDetails: undefined,
  underlyingAgreementTargetUnitDetails: undefined,
  authorisationAndAdditionalEvidence: undefined,
} as unknown as UnderlyingAgreementVariationPayload;

export const mockMalformedOriginalUnderlyingAgreementContainer = {
  ...mockOriginalUnderlyingAgreementContainer,
  underlyingAgreement: {
    ...mockOriginalUnderlyingAgreementContainer.underlyingAgreement,
    facilities: undefined,
  },
} as unknown as UnderlyingAgreementContainer;
