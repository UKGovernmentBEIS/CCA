...
export const UNDERLYING_AGREEMENT_VARIATION_SEND_FOR_PEER_REVIEW_ROUTES: Routes = [
  {
    path: '',
    resolve: {
      candidateAssignees: createCandidateAssigneesResolver('UNDERLYING_AGREEMENT_VARIATION_APPLICATION_PEER_REVIEW'),
    },
    children: [
      {
        path: '',
