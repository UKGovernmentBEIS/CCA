...
describe('TP5CheckYourAnswersComponent', () => {
  let fixture: ComponentFixture<TP5CheckYourAnswersComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TP5CheckYourAnswersComponent],
      providers: [
        provideHttpClient(),
    ...
    fixture = TestBed.createComponent(TP5CheckYourAnswersComponent);
