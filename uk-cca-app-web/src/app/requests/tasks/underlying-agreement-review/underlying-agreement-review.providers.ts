...
import { UnderlyingAgreementReviewTaskApiService } from './services/underlying-agreement-review-api.service';
...
export function provideTaskServices(): EnvironmentProviders {
  return makeEnvironmentProviders([
    { provide: TaskApiService, useClass: UnderlyingAgreementReviewTaskApiService },
    { provide: TaskService, useClass: UnderlyingAgreementReviewTaskService },
  ]);
}
