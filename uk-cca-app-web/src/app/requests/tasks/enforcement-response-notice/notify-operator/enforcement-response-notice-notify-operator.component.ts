...
@Component({
  selector: 'cca-enforcement-response-notice-notify-operator',
  template: `
    <cca-wizard-step
      (formSubmit)="onSubmit()"
      [formGroup]="form"
      caption="Notify operator of decision"
      heading="Select who should receive the enforcement response notice"
      data-testid="enforcement-response-notice-notify-operator-form"
...
export default class EnforcementResponseNoticeNotifyOperatorComponent {
