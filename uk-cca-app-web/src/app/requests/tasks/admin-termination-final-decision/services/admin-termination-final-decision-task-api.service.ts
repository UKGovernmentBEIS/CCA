...
export class AdminTerminationFinalDecisionTaskApiService extends TaskApiService {
  ...
  private createSaveAction(payload: AdminTerminationFinalDecisionRequestTaskPayload): RequestTaskActionProcessDTO & {
    requestTaskActionPayload: AdminTerminationFinalDecisionSaveRequestTaskActionPayload;
  } {
    const requestTaskId = this.store.select(requestTaskQuery.selectRequestTaskId)();
    const { adminTerminationFinalDecisionReasonDetails, sectionsCompleted } = payload;
