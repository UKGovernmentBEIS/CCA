...
import {
  UnderlyingAgreementVariationPeerReviewState,
  UnderlyingAgreementVariationPeerReviewStore,
} from '../+state/underlying-agreement-variation-peer-review.store';
import {
...
export class PeerReviewDecisionComponent {
  ...
  private readonly peerReviewStore = inject(UnderlyingAgreementVariationPeerReviewStore);
  ...
  onSubmit() {
    ...
    const statePayload: UnderlyingAgreementVariationPeerReviewState = {
      decision: {
