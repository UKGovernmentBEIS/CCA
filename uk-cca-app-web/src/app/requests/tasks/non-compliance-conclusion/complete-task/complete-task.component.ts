...
@Component({
  selector: 'cca-conclusion-complete-task',
  template: `
    <div class="govuk-!-width-two-thirds">
      <netz-page-heading caption="Provide non-compliance conclusion">Complete task</netz-page-heading>
...
export class ConclusionCompleteTaskComponent {
  ...
  onComplete() {
    ...
    const dto = {
      requestTaskId,
      requestTaskActionType: 'NON_COMPLIANCE_CONCLUSION_COMPLETE_APPLICATION',
