...
const mockUnaRequestTaskPayload: UnderlyingAgreementVariationActivationRequestTaskPayload = {
  payloadType: 'UNDERLYING_AGREEMENT_VARIATION_ACTIVATION_PAYLOAD',
...
export const mockRequestTaskItemDTO: RequestTaskItemDTO = {
  requestTask: {
    id: 20,
    type: 'UNDERLYING_AGREEMENT_VARIATION_ACTIVATION',
  ...
  allowedRequestTaskActions: [
    'UNDERLYING_AGREEMENT_VARIATION_ACTIVATION_SAVE_APPLICATION',
