...
@Component({
  selector: 'cca-underlying-agreement-variation-regulator-led-wait-for-peer-review-precontent',
  template: `
...
export class UnARegulatorLedVariationWaitForPeerReviewPrecontentComponent {}
