    ...
    children: [
      {
        ...
        loadComponent: () =>
          import('@requests/common').then(
            (c) => c.VariationDetailsSubmittedComponent,
          ),
      },
      {
        ...
        loadComponent: () =>
          import('@requests/common').then(
            (c) => c.ReviewTargetUnitDetailsSubmittedComponent,
          ),
      },
      {
        ...
        data: { backlink: '../../', breadcrumb: false },
        loadComponent: () =>
          import('@requests/common').then((c) => c.ManageFacilitiesSubmittedComponent),
      },
      {
        path: 'facility',
        children: [
      ...
      },
      {
        ...
        data: { backlink: '../../', breadcrumb: false },
        loadComponent: () =>
          import('@requests/common').then((c) => c.TargetPeriod5SubmittedComponent),
      },
      {
        ...
        data: { backlink: '../../', breadcrumb: false },
        loadComponent: () =>
          import('@requests/common').then((c) => c.TargetPeriod6SubmittedComponent),
      },
      {
        ...
        loadComponent: () =>
          import('@requests/common').then(
            (c) => c.AuthorisationAdditionalEvidenceSubmittedComponent,
          ),
      },
    ],
  },
