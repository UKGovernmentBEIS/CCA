...
export class NonComplianceDetailsSubmittedComponent {
  ...
  protected readonly data = computed(() => {
    const payload = this.actionPayload() as NonComplianceDetailsSubmittedRequestActionPayload;

    return toNonComplianceDetailsSubmittedSummaryData(
      payload.nonComplianceDetails,
      payload.allRelevantWorkflows,
      payload.allRelevantFacilities,
    );
  });
}
