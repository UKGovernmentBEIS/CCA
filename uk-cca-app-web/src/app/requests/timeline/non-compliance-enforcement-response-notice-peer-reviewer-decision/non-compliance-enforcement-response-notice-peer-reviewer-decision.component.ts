...
@Component({
  selector: 'cca-non-compliance-enforcement-response-notice-peer-reviewer-decision',
  template: `<cca-summary [data]="summaryData()" />`,
  imports: [SummaryComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NonComplianceEnforcementResponseNoticePeerReviewerDecisionComponent {
