...
export type FacilityDetailsReviewFormModel = {
...
export const FACILITY_DETAILS_REVIEW_FORM = new InjectionToken<FacilityDetails>('Facility Details Review Form');

export const FacilityDetailsReviewFormProvider: Provider = {
  provide: FACILITY_DETAILS_REVIEW_FORM,
  ...
  useFactory: (
    ...
    const group = fb.group<FacilityDetailsReviewFormModel>({
