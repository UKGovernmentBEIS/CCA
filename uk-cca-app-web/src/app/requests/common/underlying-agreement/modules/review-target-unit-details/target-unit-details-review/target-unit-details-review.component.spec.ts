...
import { TargetUnitDetailsReviewComponent } from './target-unit-details-review.component';

describe('TargetUnitDetailsReviewComponent', () => {
  let component: TargetUnitDetailsReviewComponent;
  let fixture: ComponentFixture<TargetUnitDetailsReviewComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TargetUnitDetailsReviewComponent],
      providers: [
        provideHttpClient(),
    ...
    fixture = TestBed.createComponent(TargetUnitDetailsReviewComponent);
