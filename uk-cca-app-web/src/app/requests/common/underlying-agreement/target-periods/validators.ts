...
export function targetCompositionConditionallyRequiredFieldsValidator(): ValidatorFn {
  return (group: TargetCompositionFormModel): ValidationErrors | null => {
    ...
    if (agreementCompositionTypeValue === null || agreementCompositionTypeValue === 'NOVEM') return null;
...
function handleSharedValidations(
  ...
  updateControlError(
    throughputControl,
    agreementCompositionType !== 'NOVEM' && !throughput && throughput !== 0,
    'requiredThroughput',
  ...
  updateControlError(
    ...
    !energyCarbonFactor && energyCarbonFactor !== 0,
