    ...
    facilities: [
      {
        ...
        facilityExtent: {
          manufacturingProcessFile: 'df6ebb3b-eecf-4fdb-a1b6-a72e15c1f53a',
          processFlowFile: '4e9053f2-b1ab-4f5f-968b-9b40656178ae',
          annotatedSitePlansFile: '514fe102-fa6e-4085-9321-3d3803bbc957',
          eligibleProcessFile: 'f5ebeac3-b9c0-42c7-a8ac-ce04aa4a7bf2',
          areActivitiesClaimed: false,
        },
        apply70Rule: {
          energyConsumed: 100,
          energyConsumedEligible: 100,
          evidenceFile: 'ab3fdeed-122e-4518-acd3-dc6ba16fb437',
        },
      },
      {
        status: 'NEW',
        facilityId: 'ADS_53-F00006',
        facilityDetails: {
          name: 'Facility 1',
          isCoveredByUkets: false,
          applicationReason: 'NEW_AGREEMENT',
