...
export type TpReportingSubmitErrorCode = 'TPRDF1002' | 'TPRDF1004' | 'TPRDF1008';
export type TpReportingRefreshErrorCode = 'TPRDF1002' | 'TPRDF1005' | 'TPRDF1008' | 'TPRDF1009';
...
export const TP_REPORTING_ERROR_MESSAGES = {
  ...
  TPRDF1005:
    'The baseline data for this facility must contain at least one product with a base year that is less than or equal to the year the report data relates to.  You must submit a variation to correct the base year of products in this facility before you can submit your report.',
