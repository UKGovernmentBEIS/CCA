...
describe('PhoneInputComponent', () => {
  ...
  class Page extends BasePage<TestComponent> {
    ...
    get countryCodeValue() {
      return this.countryCode ? this.countryCode.value : null;
    }
    ...
    get phoneDisabledElement() {
      return this.query<HTMLParagraphElement>('p[data-test-id="firstPhone"]');
    }

    get phoneLabel() {
      return this.query<HTMLLabelElement>('Phone number');
    }
  ...
  it('should disable and re-enable control', () => {
    ...
    expect(page.phone).toBeFalsy();
    expect(page.countryCode).toBeFalsy();

    expect(page.phoneDisabledElement.textContent.trim()).toEqual('(+30)1234567890');
