...
import { AccountNoteDto, AccountNotesService, RequestNoteDto, RequestNotesService } from 'cca-api';
...
export const EditNoteFormProvider: Provider = {
  ...
  useFactory: (
    ...
    const note = activatedRoute.snapshot.data['note'] as RequestNoteDto | AccountNoteDto | null;
