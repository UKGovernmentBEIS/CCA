...
describe('MultiSelectComponent', () => {
  @Component({
    template: `
      <form [formGroup]="form">
        <div cca-multi-select formControlName="test" label="Test label">
          <div cca-multi-select-item itemValue="1" label="Test label 1"></div>
          <div cca-multi-select-item itemValue="2" label="Test label 2"></div>
        </div>
      </form>
    `,
    standalone: true,
