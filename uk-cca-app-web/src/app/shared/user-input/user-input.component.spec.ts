...
import { createCountyAddressControl } from '@shared/county-address-input/create-county-address-controls';
...
describe('UserInputComponent', () => {
  ...
  class TestComponent {
    nationalForm = new FormGroup({
      ...
      email: new FormControl('jake.peralta@cca.uk'),
      address: new FormGroup(
        createCountyAddressControl({
          line1: 'Line 1',
          line2: 'Line 2',
          city: 'city',
          county: 'county',
    ...
    fullForm = new FormGroup({
      user: new FormGroup({
        ...
        address: new FormGroup(createCountyAddressControl(null)),
      }),
    });
  }
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UserInputComponent, GovukComponentsModule, ReactiveFormsModule],
  ...
  it('should populate the form', () => {
    ...
    expect(page.nationalEmail.value).toEqual('jake.peralta@cca.uk');
