...
import { ErrorSummaryComponent } from 'govuk-components';
...
@Component({
  selector: 'cca-verifier-invitation',
  templateUrl: './verifier-invitation.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [passwordFormFactory, DestroySubject],
  standalone: true,
  imports: [AsyncPipe, PageHeadingComponent, ReactiveFormsModule, PasswordComponent, ErrorSummaryComponent],
})
