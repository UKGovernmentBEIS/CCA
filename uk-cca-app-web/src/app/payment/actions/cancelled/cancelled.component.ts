...
import { PaymentCancelledRequestActionPayload } from 'cca-api';

import { PaymentStore } from '../../store/payment.store';

@Component({
  selector: 'cca-cancelled',
  template: `
    <ng-container *ngIf="details$ | async as details">
      <cca-request-action-heading headerText="Payment task cancelled" [timelineCreationDate]="creationDate$ | async">
