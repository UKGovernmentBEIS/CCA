...
import { CardPaymentProcessResponseDTO } from 'cca-api';
    ...
    <ng-container *ngIf="details$ | async as details">
      <div class="govuk-grid-row">
        <div class="govuk-grid-column-two-thirds">
          ...
          <cca-payment-summary [shouldDisplayAmount]="shouldDisplayAmount$ | async" [details]="details">
            <h2 cca-summary-header class="govuk-heading-m">Payment summary</h2>
          </cca-payment-summary>
        </div>
      </div>
    </ng-container>
