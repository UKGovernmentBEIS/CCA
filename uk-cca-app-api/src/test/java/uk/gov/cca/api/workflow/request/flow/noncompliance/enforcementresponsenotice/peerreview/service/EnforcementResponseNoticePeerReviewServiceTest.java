...
class EnforcementResponseNoticePeerReviewServiceTest {

    @InjectMocks
    private EnforcementResponseNoticePeerReviewService service;

    @Test
    void submitPeerReview() {
        UUID fileUuid = UUID.fromString("eb44e8cc-5bef-4550-bb63-e06993797920");
        RequestTask requestTask = RequestTask.builder()
                .payload(NonComplianceEnforcementResponseNoticePeerReviewRequestTaskPayload.builder().build())
                .build();
        ...
        // invoke
        service.submitPeerReview(requestTask, taskActionPayload);

        // verify
        NonComplianceEnforcementResponseNoticePeerReviewRequestTaskPayload requestTaskPayload =
        ...
        assertThat(requestTaskPayload.getDecision().getDecision().getNotes()).isEqualTo("bla bla bla");
    }
}
