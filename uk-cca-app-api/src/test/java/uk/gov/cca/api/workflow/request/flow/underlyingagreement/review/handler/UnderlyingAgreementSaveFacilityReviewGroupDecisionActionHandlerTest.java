...
class UnderlyingAgreementSaveFacilityReviewGroupDecisionActionHandlerTest {

	@InjectMocks
    private UnderlyingAgreementSaveFacilityReviewGroupDecisionActionHandler handler;
    ...
    void process() {
        ...
        verify(underlyingAgreementReviewService, times(1)).saveFacilityReviewGroupDecision(payload, requestTask);
    }

    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_SAVE_FACILITY_REVIEW_GROUP_DECISION);
    }
}
