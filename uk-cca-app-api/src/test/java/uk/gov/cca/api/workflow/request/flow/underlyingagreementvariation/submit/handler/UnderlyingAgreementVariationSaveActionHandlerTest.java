...
import uk.gov.cca.api.workflow.request.flow.underlyingagreementvariation.submit.service.UnderlyingAgreementVariationApplyService;
...
class UnderlyingAgreementVariationSaveActionHandlerTest {

    @InjectMocks
    private UnderlyingAgreementVariationSaveActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.UNDERLYING_AGREEMENT_SAVE_APPLICATION;
        final UnderlyingAgreementVariationSaveRequestTaskActionPayload taskActionPayload =
                UnderlyingAgreementVariationSaveRequestTaskActionPayload.builder().build();
        ...
        verify(underlyingAgreementVariationApplyService, times(1))
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_SAVE_APPLICATION);
    }
}