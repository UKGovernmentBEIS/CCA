...
class FacilityCertificationRunCompletedHandlerTest {

    @InjectMocks
    private FacilityCertificationRunCompletedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(facilityCertificationRunService, times(1)).complete(requestId);
    }
}
