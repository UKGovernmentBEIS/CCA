...
class UnderlyingAgreementVariationActivatedAddRequestActionServiceTest {

    @InjectMocks
    private UnderlyingAgreementVariationActivatedAddRequestActionService service;
    ...
    void addRequestAction() {
        ...
        verify(requestService, times(1)).addActionToRequest(request, actionPayload,
                CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_APPLICATION_ACTIVATED, assignee);
    }
}
