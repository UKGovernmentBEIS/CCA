...
class AdminTerminationFinalDecisionNotificationValidatorTest {
    ...
    void validate() {
        ...
        // Invoke
        BusinessValidationResult result = adminTerminationFinalDecisionNotificationValidator
    ...
    @Test
    void getSectionName() {
        assertThat(adminTerminationFinalDecisionNotificationValidator.getSectionName())
                .isEqualTo(AdminTerminationFinalDecisionReasonDetails.class.getName());
    }
}
