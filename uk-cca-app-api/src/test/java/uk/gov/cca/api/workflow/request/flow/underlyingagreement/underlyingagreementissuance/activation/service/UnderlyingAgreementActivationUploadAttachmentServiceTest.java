...
class UnderlyingAgreementActivationUploadAttachmentServiceTest {
    ...
    void uploadAttachment() {
        ...
        // Verify
        assertThat(((UnderlyingAgreementActivationRequestTaskPayload) requestTask.getPayload()).getUnderlyingAgreementActivationAttachments())
                .hasSize(2);
