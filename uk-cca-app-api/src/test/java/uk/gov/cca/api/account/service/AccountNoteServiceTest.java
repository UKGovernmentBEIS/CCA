...
import uk.gov.cca.api.account.repository.AccountNoteRepository;
import uk.gov.cca.api.account.service.AccountNoteService;
import uk.gov.cca.api.account.transform.AccountNoteMapper;
...
class AccountNoteServiceTest {
    ...
    void createNote_whenFilesDoNotExist_thenException() {
        ...
        assertThrows(BusinessException.class, () -> accountNoteService.createNote(appUser, accountNoteRequest));
