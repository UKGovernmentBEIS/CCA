...
class NotificationTemplateRepositoryIT extends AbstractContainerBaseTest {
    ...
    void findByNameAndCompetentAuthority_empty_ca() {
        Optional<NotificationTemplate> result = repo.findByNameAndCompetentAuthority(
                NotificationTemplateName.INVITATION_TO_OPERATOR_ACCOUNT, null);
        assertThat(result).isEmpty();
    ...
    void findManagedNotificationTemplateByIdWithDocumentTemplates() {
        ...
        DocumentTemplate documentTemplate1 = createDocumentTemplate(DocumentTemplateType.IN_RFI, "Operator Account Doc", CompetentAuthorityEnum.WALES, permitWorkflow, 1L);
        ...
        DocumentTemplate documentTemplate2 = createDocumentTemplate(DocumentTemplateType.IN_RFI, "Verifier Account Doc", CompetentAuthorityEnum.WALES, permitWorkflow, 2L);
    ...
    private DocumentTemplate createDocumentTemplate(DocumentTemplateType type, String name, CompetentAuthorityEnum ca, String workflow,
                                                    Long fileDocumentTemplateId) {
