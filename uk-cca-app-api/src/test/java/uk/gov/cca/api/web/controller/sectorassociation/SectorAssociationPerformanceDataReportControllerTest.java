...
import uk.gov.cca.api.targetperiodreporting.performancedatafacility.service.SectorPerformanceDataFacilityDataReportService;
...
class SectorAssociationPerformanceDataReportControllerTest {
    ...
    @InjectMocks
    private SectorAssociationPerformanceDataReportController controller;
    ...
    @Mock
    private SectorPerformanceDataFacilityDataReportService sectorPerformanceDataFacilityDataReportService;
    ...
    void setUp() {
        ...
        controller = (SectorAssociationPerformanceDataReportController) aopProxy.getProxy();
    ...
    void getSectorAccountPerformanceDataReportList() throws Exception {
        ...
        SectorAccountPerformanceDataReportItemDTO item = new SectorAccountPerformanceDataReportItemDTO(
        		1L, "ADS-T00001", "ADS operator", LocalDateTime.now(), 0, TargetPeriodResultType.OUTSTANDING, 
        		PerformanceDataSubmissionType.PRIMARY, false);
    ...
    @Test
    void getSectorFacilityPerformanceDataReportList() throws Exception {
        Long sectorAssociationId = 1L;
        
        SectorFacilityPerformanceDataReportSearchCriteria criteria = SectorFacilityPerformanceDataReportSearchCriteria.builder()
        		.paging(PagingRequest.builder().pageNumber(0).pageSize(30).build())
        		.targetPeriodType(TargetPeriodType.TP7)
        		.targetPeriodReportType(PerformanceDataReportType.FINAL)
        		.build();
        
        SectorFacilityPerformanceDataReportItemDTO item = new SectorFacilityPerformanceDataReportItemDTO(
        		1L, "ADS-T00001", "ADS operator", 1L);

        SectorFacilityPerformanceDataReportListDTO results = SectorFacilityPerformanceDataReportListDTO.builder()
                .performanceDataReportItems(List.of(item))
                .total(1L)
                .build();
        final AppUser user = AppUser.builder()
        ...
        when(appSecurityComponent.getAuthenticatedUser()).thenReturn(user);
        when(sectorPerformanceDataFacilityDataReportService.getSectorFacilityPerformanceDataReportList(sectorAssociationId, criteria))
        		.thenReturn(results);
        ...
        mockMvc.perform(MockMvcRequestBuilders
                		...
                		.andExpect(status().isOk())
                		.andExpect(jsonPath("$.total").value(results.getTotal()))
                        .andExpect(jsonPath("$.performanceDataReportItems[0].facilityId").value(item.getFacilityId()))
                        .andExpect(jsonPath("$.performanceDataReportItems[0].accountId").value(item.getAccountId()))
                        .andExpect(jsonPath("$.performanceDataReportItems[0].siteName").value(item.getSiteName()))
                        .andExpect(jsonPath("$.performanceDataReportItems[0].facilityBusinessId").value(item.getFacilityBusinessId()));

        verify(sectorPerformanceDataFacilityDataReportService, times(1)).getSectorFacilityPerformanceDataReportList(sectorAssociationId, criteria);
    }
    
    @Test
    void getSectorFacilityPerformanceDataReportList_forbidden() throws Exception {
        Long sectorAssociationId = 1L;
        AppUser user = AppUser.builder().userId("user").build();
        SectorFacilityPerformanceDataReportSearchCriteria criteria = SectorFacilityPerformanceDataReportSearchCriteria.builder()
        		.paging(PagingRequest.builder().pageNumber(0).pageSize(30).build())
        ...
        doThrow(new BusinessException(ErrorCode.FORBIDDEN))
                .when(appUserAuthorizationService)
                .authorize(user, "getSectorFacilityPerformanceDataReportList", String.valueOf(sectorAssociationId), null, null);
        ...
        verify(appSecurityComponent, times(1)).getAuthenticatedUser();
        verify(sectorPerformanceDataFacilityDataReportService, never()).getSectorFacilityPerformanceDataReportList(any(), any());
    }
    
    @Test
    void getSectorFacilityPerformanceDataReportList_empty_targetPeriodType() throws Exception {
        Long sectorAssociationId = 1L;
        SectorFacilityPerformanceDataReportSearchCriteria criteria = SectorFacilityPerformanceDataReportSearchCriteria.builder()
        		.paging(PagingRequest.builder().pageNumber(0).pageSize(30).build())
        		.build();
    ...
    @Test
    void getSectorFacilityPerformanceDataReportList_invalid_facilityOrTargetUnitAccountBusinessId() throws Exception {
        Long sectorAssociationId = 1L;
        SectorFacilityPerformanceDataReportSearchCriteria criteria = SectorFacilityPerformanceDataReportSearchCriteria.builder()
        		.paging(PagingRequest.builder().pageNumber(0).pageSize(30).build())
        		.targetPeriodType(TargetPeriodType.TP7)
        		.targetPeriodReportType(PerformanceDataReportType.FINAL)
        		.facilityOrTargetUnitAccountBusinessId("AI")
        		.build();
