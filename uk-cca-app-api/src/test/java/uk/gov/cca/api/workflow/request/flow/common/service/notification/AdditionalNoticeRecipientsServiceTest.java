...
class AdditionalNoticeRecipientsServiceTest {
    ...
    void getAdditionalNoticeRecipients() {
        ...
        List<AdditionalNoticeRecipientDTO> result = additionalNoticeRecipientsService.getAdditionalNoticeRecipients(user, accountId);
