...
class NonComplianceConclusionCompleteActionHandlerTest {

    @InjectMocks
    private NonComplianceConclusionCompleteActionHandler handler;
    ...
    @Mock
    private NonComplianceConclusionCompleteValidator validator;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.NON_COMPLIANCE_CONCLUSION_COMPLETE_APPLICATION;
        ...
        final RequestTaskActionEmptyPayload requestTaskActionPayload = RequestTaskActionEmptyPayload.builder().build();
        ...
        verify(nonComplianceConclusionSubmitService, times(1)).complete(requestTask, isPenaltyReissueNeeded);
        verify(workflowService, times(1)).completeTask(processId,
                Map.of(BpmnProcessConstants.REQUEST_ID, requestId,
                        ...
                        CcaBpmnProcessConstants.IS_NON_COMPLIANCE_REISSUE_PENALTY_NEEDED, isPenaltyReissueNeeded));
    }

    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(CcaRequestTaskActionType.NON_COMPLIANCE_CONCLUSION_COMPLETE_APPLICATION);
    }
}
