...
class UnderlyingAgreementSecondReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private UnderlyingAgreementSecondReminderDateReachedHandlerFlowable handler;
    @Mock
    ...
    void execute() {
        ...
        when(execution.getVariable(CcaBpmnProcessConstants.UNDERLYING_AGREEMENT_EXPIRATION_DATE)).thenReturn(expirationDate);
        ...
        verify(execution, times(1)).getVariable(CcaBpmnProcessConstants.UNDERLYING_AGREEMENT_EXPIRATION_DATE);
