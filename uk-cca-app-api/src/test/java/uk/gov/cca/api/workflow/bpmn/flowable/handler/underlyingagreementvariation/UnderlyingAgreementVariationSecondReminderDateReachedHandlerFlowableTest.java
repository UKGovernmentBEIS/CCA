...
class UnderlyingAgreementVariationSecondReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private UnderlyingAgreementVariationSecondReminderDateReachedHandlerFlowable handler;
    @Mock
