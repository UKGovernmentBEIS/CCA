...
class SubsistenceFeesMoaViewControllerTest {
    ...
    @InjectMocks
    private SubsistenceFeesMoaViewController subsistenceFeesMoaViewController;
    ...
    public void setUp() {
        ...
        AspectJProxyFactory aspectJProxyFactory = new AspectJProxyFactory(subsistenceFeesMoaViewController);
        aspectJProxyFactory.addAspect(aspect);
        aspectJProxyFactory.addAspect(authorizedRoleAspect);

        DefaultAopProxyFactory proxyFactory = new DefaultAopProxyFactory();
        AopProxy aopProxy = proxyFactory.createAopProxy(aspectJProxyFactory);
        subsistenceFeesMoaViewController = (SubsistenceFeesMoaViewController) aopProxy.getProxy();

        FormattingConversionService conversionService = new FormattingConversionService();

        mockMvc = MockMvcBuilders.standaloneSetup(subsistenceFeesMoaViewController)
    ...
    void getSubsistenceFeesMoaDetailsById() throws Exception {
        ...
        when(subsistenceFeesΜoaQueryService.getSubsistenceFeesMoaDetailsById(moaId)).thenReturn(sfrMoaDetailsDTO);
        ...
        verify(subsistenceFeesΜoaQueryService, times(1)).getSubsistenceFeesMoaDetailsById(moaId);
    }
    ...
    void getSubsistenceFeesMoaDetailsById_forbidden() throws Exception {
        ...
        verifyNoInteractions(subsistenceFeesΜoaQueryService);
    }
