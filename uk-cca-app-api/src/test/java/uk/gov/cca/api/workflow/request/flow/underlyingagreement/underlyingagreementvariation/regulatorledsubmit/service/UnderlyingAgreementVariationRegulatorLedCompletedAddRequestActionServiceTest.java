...
class UnderlyingAgreementVariationRegulatorLedCompletedAddRequestActionServiceTest {

    @InjectMocks
    private UnderlyingAgreementVariationRegulatorLedCompletedAddRequestActionService service;
    ...
    void addRequestAction() {
        ...
        final UnderlyingAgreementVariationRegulatorLedCompletedRequestActionPayload actionPayload =
                UnderlyingAgreementVariationRegulatorLedCompletedRequestActionPayload.builder()
                        .payloadType(CcaRequestActionPayloadType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_COMPLETED_PAYLOAD)
                        .usersInfo(usersInfo)
        ...
        verify(requestService, times(1)).addActionToRequest(request, actionPayload,
                CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_COMPLETED, assignee);
    }
}
