...
class AdminTerminationPeerReviewDecisionActionHandlerTest {

    @InjectMocks
    private AdminTerminationPeerReviewDecisionActionHandler handler;
    ...
    void process() {
        ...
        final CcaPeerReviewDecisionRequestTaskActionPayload payload =
                CcaPeerReviewDecisionRequestTaskActionPayload.builder()
                        .payloadType(CcaRequestTaskActionPayloadType.ADMIN_TERMINATION_SUBMIT_PEER_REVIEW_DECISION_PAYLOAD)
        ...
        final AdminTerminationPeerReviewRequestTaskPayload requestTaskPayload = AdminTerminationPeerReviewRequestTaskPayload.builder()
        ...
        handler.process(requestTask.getId(),
                CcaRequestTaskActionType.ADMIN_TERMINATION_SUBMIT_PEER_REVIEW_DECISION,
                appUser,
                payload);
        ...
        verify(requestService, times(1)).addActionToRequest(
                ...
                eq(CcaRequestActionType.ADMIN_TERMINATION_APPLICATION_PEER_REVIEWER_REJECTED),
                eq(userId));
        ...
        assertThat(captorValue.getPayloadType()).isEqualTo(CcaRequestActionPayloadType.ADMIN_TERMINATION_PEER_REVIEW_SUBMITTED_PAYLOAD);
    ...
    void getRequestTaskTypes() {
        assertThat(handler.getTypes()).containsExactly(CcaRequestTaskActionType.ADMIN_TERMINATION_SUBMIT_PEER_REVIEW_DECISION);
    }
}
