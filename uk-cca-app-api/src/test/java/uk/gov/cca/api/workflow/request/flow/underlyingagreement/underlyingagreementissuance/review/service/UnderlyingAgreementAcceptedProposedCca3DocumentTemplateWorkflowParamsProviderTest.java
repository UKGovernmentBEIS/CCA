...
class UnderlyingAgreementAcceptedProposedCca3DocumentTemplateWorkflowParamsProviderTest {

	@InjectMocks
    private UnderlyingAgreementAcceptedProposedCca3DocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
        ...
        when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, null, SchemeVersion.CCA_3, version))
        ...
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
                .constructTemplateParams(una, null, SchemeVersion.CCA_3, version);
    }
}
