...
class Cca3SectorAssociationSchemeDataMigrationServiceTest {

	@InjectMocks
	private Cca3SectorAssociationSchemeDataMigrationService migrationService;
	...
	void migrate() {
		...
		final FtpFileDTOResult fileDTOResult = FtpFileDTOResult.builder()
				.fileDTO(FileDTO.builder()
						...
						.build())
				.build();
		final List<Cca3SectorAssociationSchemeDataVO> dataList = List.of(
				Cca3SectorAssociationSchemeDataVO.builder()
