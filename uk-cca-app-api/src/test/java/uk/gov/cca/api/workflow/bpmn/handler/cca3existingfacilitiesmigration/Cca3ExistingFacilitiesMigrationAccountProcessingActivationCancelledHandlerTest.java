...
class Cca3ExistingFacilitiesMigrationAccountProcessingActivationCancelledHandlerTest {

    @InjectMocks
    private Cca3ExistingFacilitiesMigrationAccountProcessingActivationCancelledHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(cca3ExistingFacilitiesMigrationAccountProcessingActivationService, times(1)).cancel(requestId);
    }
}
