package uk.gov.cca.api.workflow.request.application.requestaction;
...
import uk.gov.cca.api.workflow.request.core.transform.RequestActionCustomMapperHandler;
...
class RequestActionQueryServiceTest {
    ...
    void getRequestActionsByRequestId() {
        ...
        RequestActionType requestActionType1 = RequestActionType.REQUEST_TERMINATED;
        ...
        RequestAction requestAction2 = RequestAction.builder()
                .id(2L)
                .type(RequestActionType.RDE_ACCEPTED)
                .submitterId("user2")
                .submitter("fn ln 2")
                .build();
        ...
        Set<String> userAllowedRequestActionTypes = Set.of(RequestActionType.REQUEST_TERMINATED.toString());
