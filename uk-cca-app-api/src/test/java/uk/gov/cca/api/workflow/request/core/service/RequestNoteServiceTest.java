...
import uk.gov.cca.api.workflow.request.core.domain.RequestNote;
...
import uk.gov.cca.api.workflow.request.core.transform.RequestNoteMapper;
...
class RequestNoteServiceTest {
    ...
    void createNote_whenFilesDoNotExist_thenException() {
        ...
        assertThrows(BusinessException.class, () -> requestNoteService.createNote(appUser, requestNoteRequest));
