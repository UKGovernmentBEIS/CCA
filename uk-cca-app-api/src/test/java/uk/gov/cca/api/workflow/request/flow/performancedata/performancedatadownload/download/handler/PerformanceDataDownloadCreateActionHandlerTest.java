...
class PerformanceDataDownloadCreateActionHandlerTest {

    @InjectMocks
    private PerformanceDataDownloadCreateActionHandler handler;
    ...
    @Test
    void getRequestType() {
        assertThat(handler.getRequestType()).isEqualTo(CcaRequestType.PERFORMANCE_DATA_DOWNLOAD);
    }
}
