...
class UnderlyingAgreementVariationCompletedGenerateOfficialNoticeHandlerTest {

    @InjectMocks
    private UnderlyingAgreementVariationCompletedGenerateOfficialNoticeHandler handler;
