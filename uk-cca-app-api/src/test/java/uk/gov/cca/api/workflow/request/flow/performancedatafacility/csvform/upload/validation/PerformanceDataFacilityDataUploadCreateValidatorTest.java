...
class PerformanceDataFacilityDataUploadCreateValidatorTest {

    @InjectMocks
    private PerformanceDataFacilityDataUploadCreateValidator validator;
    ...
    void validateAction() {
        ...
        when(ccaRequestCreateValidatorService
                .validate(sectorId, CcaResourceType.SECTOR_ASSOCIATION, Set.of(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD)))
    ...
    void getRequestType() {
        assertThat(validator.getRequestType())
                .isEqualTo(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD);
    }
}
