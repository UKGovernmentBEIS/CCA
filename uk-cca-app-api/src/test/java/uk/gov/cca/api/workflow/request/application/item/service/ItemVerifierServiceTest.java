...
import uk.gov.cca.api.workflow.request.application.item.service.ItemVerifierService;
...
class ItemVerifierServiceTest {
    ...
    void getItemsByRequest() {
        ...
        Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes =
            Map.of(verificationBodyId, Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW));
