...
class NoticeOfIntentPeerReviewServiceTest {

    @InjectMocks
    private NoticeOfIntentPeerReviewService service;

    @Test
    void submitPeerReview() {
        UUID fileUuid = UUID.fromString("eb44e8cc-5bef-4550-bb63-e06993797920");
        RequestTask requestTask = RequestTask.builder()
                .payload(NonComplianceNoticeOfIntentPeerReviewRequestTaskPayload.builder().build())
                .build();
        ...
        // verify
        NonComplianceNoticeOfIntentPeerReviewRequestTaskPayload requestTaskPayload =
