...
class UnderlyingAgreementSaveActionHandlerTest {

    @InjectMocks
    private UnderlyingAgreementSaveActionHandler handler;
    ...
    void process() {
        ...
        final UnderlyingAgreementSaveRequestTaskActionPayload taskActionPayload =
                UnderlyingAgreementSaveRequestTaskActionPayload.builder().build();
        ...
        verify(underlyingAgreementApplyService, times(1))
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_SAVE_APPLICATION);
    }
}
