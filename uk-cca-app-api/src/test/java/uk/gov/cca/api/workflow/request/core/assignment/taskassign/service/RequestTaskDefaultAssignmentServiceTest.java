...
import uk.gov.cca.api.workflow.request.core.assignment.taskassign.service.RequestTaskDefaultAssignmentService;
import uk.gov.netz.api.common.domain.RoleType;
import uk.gov.cca.api.workflow.request.core.assignment.taskassign.service.operator.OperatorRequestTaskDefaultAssignmentService;
import uk.gov.cca.api.workflow.request.core.assignment.taskassign.service.regulator.RegulatorRequestTaskDefaultAssignmentService;
...
class RequestTaskDefaultAssignmentServiceTest {
    ...
    void assignDefaultAssigneeToTask_operator() {
        RequestTask requestTask = RequestTask.builder().type(mock(RequestTaskType.class)).build();
