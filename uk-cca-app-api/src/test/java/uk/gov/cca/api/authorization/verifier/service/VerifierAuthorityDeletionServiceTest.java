...
import static uk.gov.netz.api.common.exception.ErrorCode.AUTHORITY_VERIFIER_ADMIN_SHOULD_EXIST;
...
class VerifierAuthorityDeletionServiceTest {
    ...
    void deleteVerifierAuthority_verifier_auth_user() {
        ...
        AppAuthority appAuthority = AppAuthority.builder().verificationBodyId(verificationBodyId).build();
