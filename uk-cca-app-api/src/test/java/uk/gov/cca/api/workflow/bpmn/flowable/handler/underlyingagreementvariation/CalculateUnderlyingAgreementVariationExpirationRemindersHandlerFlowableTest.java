...
class CalculateUnderlyingAgreementVariationExpirationRemindersHandlerFlowableTest {

    @InjectMocks
    private CalculateUnderlyingAgreementVariationExpirationRemindersHandlerFlowable handler;
    ...
    void execute() {
        ...
        when(requestExpirationVarsBuilder.buildExpirationVars(CcaRequestExpirationKey.UNDERLYING_AGREEMENT_VARIATION, expirationDate))
                .thenReturn(Map.of());
