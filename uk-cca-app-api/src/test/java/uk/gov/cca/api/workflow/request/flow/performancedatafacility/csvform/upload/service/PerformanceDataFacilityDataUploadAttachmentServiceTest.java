...
class PerformanceDataFacilityDataUploadAttachmentServiceTest {

    @InjectMocks
    private PerformanceDataFacilityDataUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        // Verify
        assertThat(((PerformanceDataFacilityDataUploadSubmitRequestTaskPayload) requestTask.getPayload()).getUploadAttachments())
                .hasSize(2);
