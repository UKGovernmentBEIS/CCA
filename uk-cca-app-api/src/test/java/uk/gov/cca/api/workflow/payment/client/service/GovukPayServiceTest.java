package uk.gov.cca.api.workflow.payment.client.service;
...
import uk.gov.cca.api.workflow.payment.client.service.GovukPayService;
import uk.gov.netz.api.common.exception.BusinessException;
import uk.gov.netz.api.common.exception.ErrorCode;
import uk.gov.netz.api.competentauthority.CompetentAuthorityEnum;
import uk.gov.cca.api.workflow.payment.client.domain.CreatePaymentRequest;
import uk.gov.cca.api.workflow.payment.client.domain.Link;
import uk.gov.cca.api.workflow.payment.client.domain.PaymentLinks;
import uk.gov.cca.api.workflow.payment.client.domain.PaymentResponse;
import uk.gov.cca.api.workflow.payment.client.domain.PaymentState;
import uk.gov.cca.api.workflow.payment.client.domain.enumeration.RestEndPointEnum;
import uk.gov.cca.api.workflow.payment.config.property.GovukPayProperties;
import uk.gov.cca.api.workflow.payment.domain.dto.PaymentCreateInfo;
import uk.gov.cca.api.workflow.payment.domain.dto.PaymentCreateResult;
import uk.gov.cca.api.workflow.payment.domain.dto.PaymentGetInfo;
import uk.gov.cca.api.workflow.payment.domain.dto.PaymentGetResult;
import uk.gov.cca.api.workflow.payment.domain.dto.PaymentStateInfo;
...
class GovukPayServiceTest {
    ...
    void getPayment() {
        ...
        PaymentGetInfo paymentGetInfo = PaymentGetInfo.builder()
            ...
            .build();
        String apiKey = "api_key";
        String serviceUrl = "http://www.netz.org.uk";
