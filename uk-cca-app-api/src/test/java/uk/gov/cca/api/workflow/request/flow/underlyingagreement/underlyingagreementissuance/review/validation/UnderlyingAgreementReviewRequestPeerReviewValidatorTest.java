...
class UnderlyingAgreementReviewRequestPeerReviewValidatorTest {
    ...
    void validate() {
        ...
        when(peerReviewValidator.validate(requestTask, payload, appUser, CcaRequestTaskType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEW))
                .thenReturn(BusinessValidationResult.valid());

        // Invoke
        underlyingAgreementReviewRequestPeerReviewValidator.validate(requestTask, payload, appUser);
        ...
        verify(peerReviewValidator, times(1))
                .validate(requestTask, payload, appUser, CcaRequestTaskType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEW);
    }
}
