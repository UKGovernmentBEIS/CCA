...
class CalculateFacilityAuditExpirationDateHandlerTest {

    @InjectMocks
    private CalculateFacilityAuditExpirationDateHandler handler;
    ...
    void execute_with_null_expiration_date() {
        ...
        verify(requestTaskTimeManagementService, never()).setDueDateToTasks(any(), any(), any());
    }
}
