...
import uk.gov.cca.api.workflow.request.flow.underlyingagreement.underlyingagreementissuance.activation.service.UnderlyingAgreementActivationService;
import uk.gov.netz.api.authorization.core.domain.AppUser;
import uk.gov.netz.api.workflow.request.core.domain.RequestTask;
import uk.gov.netz.api.workflow.request.core.service.RequestTaskService;

@ExtendWith(MockitoExtension.class)
class UnderlyingAgreementActivationSaveActionHandlerTest {

	@InjectMocks
    private UnderlyingAgreementActivationSaveActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.UNDERLYING_AGREEMENT_ACTIVATION_SAVE_APPLICATION;
        final UnderlyingAgreementActivationSaveRequestTaskActionPayload taskActionPayload =
        		UnderlyingAgreementActivationSaveRequestTaskActionPayload.builder().build();
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_ACTIVATION_SAVE_APPLICATION);
    }
}
