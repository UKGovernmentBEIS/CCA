...
class ItemByRequestOperatorRepositoryIT extends AbstractContainerBaseTest {
    ...
    void findItemsByRequestId() {
        ...
        Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes =
                Map.of(account1, Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, RequestTaskType.DUMMY_REQUEST_TASK_TYPE2));
        ...
        RequestTask requestTask1 =
                createRequestTask(user, request1, RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, "t1", LocalDateTime.now());
        RequestTask requestTask2 =
                createRequestTask(user, request1, RequestTaskType.DUMMY_REQUEST_TASK_TYPE2, "t2", LocalDateTime.now());

        Request request2 = createRequest(account1, RequestType.DUMMY_REQUEST_TYPE, RequestStatus.IN_PROGRESS, 2L, LocalDateTime.now());
        createRequestTask("anotherUser", request2, RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, "t4", LocalDateTime.now());
