...
import uk.gov.cca.api.account.domain.dto.ServiceContactDetails;
import uk.gov.cca.api.account.domain.enumeration.AccountContactType;
import uk.gov.cca.api.account.domain.event.FirstPrimaryContactAssignedToAccountEvent;
import uk.gov.cca.api.account.domain.event.FirstServiceContactAssignedToAccountEvent;
...
import uk.gov.cca.api.account.service.validator.AccountContactTypeUpdateValidator;
import uk.gov.cca.api.account.service.validator.PrimaryContactValidator;
