...
class UnderlyingAgreementVariationReviewUploadAttachmentServiceTest {

    @InjectMocks
    private UnderlyingAgreementVariationReviewUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        RequestTask requestTask = RequestTask.builder()
                .id(requestTaskId)
                .payload(UnderlyingAgreementVariationReviewRequestTaskPayload.builder().build())
                .build();
        ...
        assertThat(((UnderlyingAgreementVariationReviewRequestTaskPayload) requestTask.getPayload()).getReviewAttachments())
