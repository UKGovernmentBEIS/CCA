...
class UnderlyingAgreementCancelActionHandlerTest {
    ...
    @InjectMocks
    private UnderlyingAgreementCancelActionHandler handler;
    ...
    void testProcess() {
        ...
        RequestTask requestTask = RequestTask.builder()
        		...
        		.type(RequestTaskType.builder().code(CcaRequestTaskType.UNDERLYING_AGREEMENT_APPLICATION_SUBMIT).build())
        		.build();
        ...
        verify(workflowService, times(1))
                .completeTask(processTaskId, Map.of(CcaBpmnProcessConstants.UNDERLYING_AGREEMENT_OUTCOME, UnderlyingAgreementOutcome.CANCELLED,
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_CANCEL_APPLICATION);
    }
}
