...
class PerformanceDataFacilityDigitalFormSubmittedMapperTest {

    private final PerformanceDataFacilityDigitalFormSubmittedMapper mapper = Mappers.getMapper(PerformanceDataFacilityDigitalFormSubmittedMapper.class);
    ...
    void toPerformanceDataFacility() {
        ...
        final PerformanceDataFacilityDigitalFormRequestPayload requestPayload = PerformanceDataFacilityDigitalFormRequestPayload.builder()
        ...
        // Invoke
        PerformanceDataFacility result = mapper.toPerformanceDataFacility(requestPayload, container);
