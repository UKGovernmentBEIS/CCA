...
import uk.gov.cca.api.workflow.request.TestRequestTaskActionPayload;
...
class ProcessRequestTaskAspectTest {
    ...
    void validateProcessRequestTask() {
        ...
        final Object[] arguments = new Object[]{1L,
                RequestTaskActionType.PAYMENT_PAY_BY_CARD, user, TestRequestTaskActionPayload.builder().build()};
        final RequestTask requestTask = RequestTask.builder()
                .assignee("userId").type(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW).build();
        ...
        doNothing().when(requestTaskActionValidatorService).validate(requestTask,
                RequestTaskActionType.PAYMENT_PAY_BY_CARD);
    ...
    void validateProcessRequestTask_not_valid_assignee() {
        final AppUser user = AppUser.builder().userId("userId").build();
        final Object[] arguments = new Object[]{1L,
                RequestTaskActionType.PAYMENT_MARK_AS_RECEIVED, user, TestRequestTaskActionPayload.builder().build()};
        final RequestTask requestTask = RequestTask.builder()
                .assignee("userId2").type(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW).build();
    ...
    void validateProcessRequestTask_not_valid_action() {
        final AppUser user = AppUser.builder().userId("userId").build();
        final Object[] arguments = new Object[]{1L,
            RequestTaskActionType.PAYMENT_CANCEL, user, TestRequestTaskActionPayload.builder().build()};
        final RequestTask requestTask = RequestTask.builder()
                .assignee("userId").type(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW).build();
    ...
    void validateProcessRequestTask_whenCustomValidationFails_thenThrowException() {
        ...
        final AppUser user = AppUser.builder().userId("userId").build();
        final Object[] arguments = new Object[]{1L,
                RequestTaskActionType.PAYMENT_PAY_BY_CARD, user,
        ...
        doThrow(new BusinessException(ErrorCode.REQUEST_TASK_ACTION_CANNOT_PROCEED))
            ...
            .validate(requestTask, RequestTaskActionType.PAYMENT_PAY_BY_CARD);
