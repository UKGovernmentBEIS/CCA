...
class NonComplianceCreateActionHandlerTest {
    ...
    void process() {
        ...
        final int version = 1;
        final Map<SchemeVersion, Integer> versionIntegerMap = Map.of(SchemeVersion.CCA_3, version);
    ...
    @Test
    void getRequestType() {
        assertThat(handler.getRequestType()).isEqualTo(CcaRequestType.NON_COMPLIANCE);
    }
}
