...
@Testcontainers
@DataJpaTest
@Import({ObjectMapper.class, ItemSectorUserRepository.class})
class ItemSectorUserRepositoryIT extends CcaRequestAbstractTest {
	
	@Autowired
    private ItemSectorUserRepository cut;
    ...
    void findItems_filterByFacilitySiteNameOrBusinessId() {
        ...
        Map<Long, Set<String>> scopedRequestTaskTypes = Map.of(
            1L, Set.of(requestTaskTypeCode1)
        );
    ...
    @Test
    void findItems_filterBySectorAcronym() {
    	String searchTerm = "ADS";
    	SectorAssociation sector1 = createSector("ADS1");
    	SectorAssociation sector2 = createSector("ADF2");
        String user = "user";
        ...
        Map<Long, Set<String>> scopedRequestTaskTypes = Map.of(
        		sector1.getId(), Set.of(requestTaskTypeCode1),
        		sector2.getId(), Set.of(requestTaskTypeCode1)
        );
