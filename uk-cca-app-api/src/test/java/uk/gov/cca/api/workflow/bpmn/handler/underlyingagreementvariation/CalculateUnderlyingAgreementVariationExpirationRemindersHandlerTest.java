...
class CalculateUnderlyingAgreementVariationExpirationRemindersHandlerTest {

    @InjectMocks
    private CalculateUnderlyingAgreementVariationExpirationRemindersHandler handler;
