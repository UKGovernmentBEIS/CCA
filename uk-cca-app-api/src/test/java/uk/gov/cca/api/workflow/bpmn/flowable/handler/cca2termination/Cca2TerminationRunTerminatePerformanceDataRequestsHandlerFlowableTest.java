...
class Cca2TerminationRunTerminatePerformanceDataRequestsHandlerFlowableTest {

	@InjectMocks
    private Cca2TerminationRunTerminatePerformanceDataRequestsHandlerFlowable handler;
    ...
    void execute() {
        ...
        // Verify
        verify(service, times(1)).terminatePerformanceDataRequests();
    }
}
