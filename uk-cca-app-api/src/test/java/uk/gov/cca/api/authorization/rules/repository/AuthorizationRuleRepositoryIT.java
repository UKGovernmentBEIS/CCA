...
import uk.gov.cca.api.authorization.rules.domain.AuthorizedService;
...
class AuthorizationRuleRepositoryIT extends AbstractContainerBaseTest {
    ...
    void findRulePermissionsByServiceAndRoleType_AuthorizationRuleScopePermission_with_same_role_type() {
		...
		ResourceScopePermission scope1 = buildPermissionScope(ResourceType.REQUEST_TASK, "taskType1",
				Permission.PERM_CA_USERS_EDIT, Scope.REQUEST_TASK_EXECUTE, RoleType.REGULATOR);
        entityManager.persist(scope1);
    ...
    private AuthorizationRule buildRule(String resourceType, String resourceSubType, String handler, String scope, RoleType roleType) {
    ...
    private ResourceScopePermission buildPermissionScope(String resourceType, String resourceSubType, String permission, String scope, RoleType roleType) {
