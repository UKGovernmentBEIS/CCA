...
class AdminTerminationSubmittedHandlerFlowableTest {

	@InjectMocks
    private AdminTerminationSubmittedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(adminTerminationSubmittedService, times(1)).submit(requestId);
    }
}
