...
class FacilityAuditUploadAttachmentServiceTest {
    ...
    void uploadAttachment() {
        ...
        final PreAuditReviewSubmitRequestTaskPayload payload = PreAuditReviewSubmitRequestTaskPayload.builder().build();
