...
class Cca2ExtensionNoticeAccountProcessingCreateValidatorTest {

    @InjectMocks
    private Cca2ExtensionNoticeAccountProcessingCreateValidator validator;
    ...
    void validateAction() {
        ...
        when(requestQueryService
                .existsRequestByAccountAndType(accountId, CcaRequestType.CCA2_EXTENSION_NOTICE_ACCOUNT_PROCESSING))
                .thenReturn(false);
    ...
    void validateAction_request_exist_not_valid() {
        ...
        assertThat(result).isEqualTo(RequestCreateValidationResult.builder()
                .valid(false)
                .reportedRequestTypes(Set.of(CcaRequestType.CCA2_EXTENSION_NOTICE_ACCOUNT_PROCESSING))
                .build());
        verify(requestQueryService, times(1))
                .existsRequestByAccountAndType(accountId, CcaRequestType.CCA2_EXTENSION_NOTICE_ACCOUNT_PROCESSING);
    ...
    @Test
    void getRequestType() {
        assertThat(validator.getRequestType()).isEqualTo(CcaRequestType.CCA2_EXTENSION_NOTICE_ACCOUNT_PROCESSING);
    }
}
