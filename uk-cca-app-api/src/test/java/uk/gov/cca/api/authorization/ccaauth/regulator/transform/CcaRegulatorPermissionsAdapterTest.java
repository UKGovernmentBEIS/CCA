...
class CcaRegulatorPermissionsAdapterTest {
    ...
    void getPermissionsFromPermissionGroupLevels_one_permission_per_group_level() {
        Map<String, RegulatorPermissionLevel> permissionGroupLevels =
                Map.ofEntries(Map.entry(MANAGE_USERS_AND_CONTACTS, NONE),
                        ...
                        Map.entry(MANAGE_SECTOR_ADVANCED_DETAILS, EXECUTE));
        ...
        List<String> expectedPermissions = List.of(
                ...
                PERM_NON_COMPLIANCE_PEER_REVIEW, PERM_SECTOR_ADVANCED_DETAILS_EDIT);
    ...
    void getPermissionsFromPermissionGroupLevels_multiple_permissions() {
        ...
        List<String> expectedPermissions = List.of(
                ...
                PERM_SECTOR_ADVANCED_DETAILS_EDIT);
    ...
    void getPermissionGroupLevelsFromPermissions_multiple_permissions_per_group_level() {
        ...
        expectedPermissionGroupLevels.put(MANAGE_SECTOR_ADVANCED_DETAILS, EXECUTE);
    ...
    void getPermissionGroupLevels() {
        ...
        expectedPermissionGroupLevels.put(UNDERLYING_AGREEMENT_VARIATION_SUBMISSION, List.of(NONE, EXECUTE));
        expectedPermissionGroupLevels.put(UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEW, List.of(NONE, EXECUTE));
        ...
        expectedPermissionGroupLevels.put(MANAGE_SECTOR_ADVANCED_DETAILS, List.of(NONE, EXECUTE));
