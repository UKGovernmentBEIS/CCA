...
class PerformanceDataFacilityDataUploadCreateActionHandlerTest {

    @InjectMocks
    private PerformanceDataFacilityDataUploadCreateActionHandler handler;
    ...
    void process() {
        ...
        final CcaRequestParams requestParams = CcaRequestParams.builder()
                .type(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD)
                ...
                .requestMetadata(PerformanceDataFacilityDataUploadRequestMetadata.builder()
                        .type(CcaRequestMetadataType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD)
                        .build())
                .requestPayload(PerformanceDataFacilityDataUploadRequestPayload.builder()
                        .payloadType(CcaRequestPayloadType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD_PAYLOAD)
    ...
    @Test
    void getRequestType() {
        assertThat(handler.getRequestType()).isEqualTo(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD);
    }
}
