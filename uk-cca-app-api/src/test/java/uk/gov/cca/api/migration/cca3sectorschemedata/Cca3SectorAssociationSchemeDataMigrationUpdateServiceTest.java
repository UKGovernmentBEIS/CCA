...
class Cca3SectorAssociationSchemeDataMigrationUpdateServiceTest {

	@InjectMocks
	private Cca3SectorAssociationSchemeDataMigrationUpdateService updateService;

	@Mock
	private Cca3SectorSubsectorSchemeDataMigrationService sectorSubsectorMigrationService;

	@Test
	void updateSectorAssociationDataList() {
		final Cca3SectorAssociationSchemeDataVO vo1 = Cca3SectorAssociationSchemeDataVO.builder()
		...
		final Cca3SectorAssociationSchemeDataVO vo2 = Cca3SectorAssociationSchemeDataVO.builder()
				.sectorAcronym("ADS_1")
		...
		final UpdateSectorAssociationSchemeDataVO updateVo1 = UpdateSectorAssociationSchemeDataVO.builder()
				.sectorAcronym("ADS_53")
				.subsectorName("SUBSECTOR_3")
				.measurementType(MeasurementType.ENERGY_KWH)
				...
				.umaDate(LocalDate.of(2023, 11, 28))
				.build();
		final UpdateSectorAssociationSchemeDataVO updateVo2 = UpdateSectorAssociationSchemeDataVO.builder()
				.sectorAcronym("ADS_1")
				.measurementType(MeasurementType.ENERGY_MWH)
				.improvementTargetsByPeriod(Map.of(
