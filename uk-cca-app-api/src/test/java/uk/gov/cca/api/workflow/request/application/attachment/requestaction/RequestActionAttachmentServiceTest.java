package uk.gov.cca.api.workflow.request.application.attachment.requestaction;
...
import uk.gov.cca.api.workflow.request.TestRequestActionPayload;
...
class RequestActionAttachmentServiceTest {
    ...
    void generateGetFileAttachmentToken_attachment_not_exists_in_payload() {
        ...
        TestRequestActionPayload payload = TestRequestActionPayload
            .builder()
            .payloadType(mock(RequestActionPayloadType.class))
            .build();
