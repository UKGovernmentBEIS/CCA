...
class AdminTerminationSubmitSaveActionHandlerTest {

    @InjectMocks
    private AdminTerminationSubmitSaveActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.ADMIN_TERMINATION_SAVE_APPLICATION;
        final AdminTerminationSaveRequestTaskActionPayload taskActionPayload =
                AdminTerminationSaveRequestTaskActionPayload.builder().build();
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.ADMIN_TERMINATION_SAVE_APPLICATION);
    }
}
