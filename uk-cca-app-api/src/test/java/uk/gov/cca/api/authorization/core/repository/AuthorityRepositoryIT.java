package uk.gov.cca.api.authorization.core.repository;
...
import uk.gov.cca.api.authorization.core.domain.AuthorityPermission;
...
import uk.gov.cca.api.authorization.core.domain.Role;
import uk.gov.cca.api.authorization.core.domain.dto.AuthorityRoleDTO;
...
import static uk.gov.cca.api.authorization.core.domain.AuthorityStatus.DISABLED;
import static uk.gov.cca.api.authorization.core.domain.AuthorityStatus.PENDING;
...
class AuthorityRepositoryIT extends AbstractContainerBaseTest {
    ...
    @Sql(statements = {
        ...
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (1, 1, 'PERM_TASK_ASSIGNMENT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (2, 1, 'PERM_ACCOUNT_USERS_EDIT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (3, 2, 'PERM_TASK_ASSIGNMENT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (4, 2, 'PERM_ACCOUNT_USERS_EDIT')"
    })
    @Test
    void findPermissionsByUserId() {
        final String userId = "regulator_user_1";
        List<String> permissions = repo.findAssignedPermissionsByUserId(userId);
        assertThat(permissions).hasSize(2).containsOnly(PERM_TASK_ASSIGNMENT, PERM_ACCOUNT_USERS_EDIT);
    }
    ...
    @Sql(statements = {
        ...
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (1, 1, 'PERM_TASK_ASSIGNMENT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (2, 1, 'PERM_ACCOUNT_USERS_EDIT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (3, 2, 'PERM_ACCOUNT_USERS_EDIT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (4, 3, 'PERM_ACCOUNT_USERS_EDIT')",
    })
    @Test
    ...
    @Sql(statements = {
        ...
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (1, 1, 'PERM_TASK_ASSIGNMENT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (2, 2, 'PERM_ACCOUNT_USERS_EDIT')",
        "INSERT INTO au_authority_permission (id, authority_id, permission) VALUES (3, 2, 'PERM_CA_USERS_EDIT')",
	...
	private ResourceScopePermission createResourceScopePermission(
        String resourceType, String resourceSubType, String scope, String permission) {
