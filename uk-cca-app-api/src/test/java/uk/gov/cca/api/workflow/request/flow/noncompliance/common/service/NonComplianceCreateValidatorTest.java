...
class NonComplianceCreateValidatorTest {
    ...
    void validateAction_whenValid_thenOk() {
        ...
        Set<AccountStatus> applicableAccountStatuses = Set.of(TargetUnitAccountStatus.LIVE, TargetUnitAccountStatus.TERMINATED);
    ...
    void getApplicableAccountStatuses() {
        Set<AccountStatus> accountStatuses = Set.of(TargetUnitAccountStatus.LIVE, TargetUnitAccountStatus.TERMINATED);
    ...
    @Test
    void getRequestType() {
        assertThat(validator.getRequestType()).isEqualTo(CcaRequestType.NON_COMPLIANCE);
    }
}
