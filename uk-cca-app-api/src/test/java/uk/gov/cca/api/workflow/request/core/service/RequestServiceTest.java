...
class RequestServiceTest {
    ...
    void addActionToRequest() {
    	...
    	final RequestActionType type = mock(RequestActionType.class);
        Request request = createRequest("1", "1", 1L, mock(RequestType.class));
    ...
    void terminateRequest() {
    	//prepare data
        String processId = "1";
        Request request = createRequest("1", processId, 1L, mock(RequestType.class));
        request.setPayload(TestRequestPayload.builder()
            .payloadType(mock(RequestPayloadType.class))
        .build()
        );
    ...
    void terminateRequest_not_same_process_instance() {
        //prepare data
        String processId = "1";
        Request request = createRequest("1","2", 1L, mock(RequestType.class));
        request.setStatus(RequestStatus.IN_PROGRESS);
