...
class UnderlyingAgreementRejectedAddRequestActionServiceTest {

    @InjectMocks
    private UnderlyingAgreementRejectedAddRequestActionService service;
    ...
    void addRequestAction() {
        ...
        UnderlyingAgreementRejectedRequestActionPayload actionPayload =
                UnderlyingAgreementRejectedRequestActionPayload.builder()
