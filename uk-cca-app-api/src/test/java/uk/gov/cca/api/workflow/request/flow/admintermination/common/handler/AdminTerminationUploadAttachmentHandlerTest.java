...
class AdminTerminationUploadAttachmentHandlerTest {

    @InjectMocks
    private AdminTerminationUploadAttachmentHandler handler;
    ...
    void uploadAttachment() {
        ...
        // Verify
        verify(adminTerminationUploadAttachmentService, times(1))
    ...
    void getType() {
        assertThat(handler.getType())
                .isEqualTo(CcaRequestTaskActionType.ADMIN_TERMINATION_UPLOAD_ATTACHMENT);
    }
