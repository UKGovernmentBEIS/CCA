...
class UnderlyingAgreementActivationSubmitValidatorTest {
    ...
    void validate() {
        ...
        // Invoke
        BusinessValidationResult result = underlyingAgreementActivationSubmitValidator.validate(taskPayload);
    ...
    void validate_empty_data_not_valid() {
        final UnderlyingAgreementActivationRequestTaskPayload taskPayload =
                UnderlyingAgreementActivationRequestTaskPayload.builder().build();
