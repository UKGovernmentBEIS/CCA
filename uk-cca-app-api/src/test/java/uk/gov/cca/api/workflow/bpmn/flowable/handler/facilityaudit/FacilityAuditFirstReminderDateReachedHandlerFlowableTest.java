...
class FacilityAuditFirstReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private FacilityAuditFirstReminderDateReachedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(reminderNotificationService, times(1)).sendFirstReminderNotification(requestId, expirationDate);
    }
}
