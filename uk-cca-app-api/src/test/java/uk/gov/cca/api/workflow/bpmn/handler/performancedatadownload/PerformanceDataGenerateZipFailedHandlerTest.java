...
class PerformanceDataGenerateZipFailedHandlerTest {

    @InjectMocks
    private PerformanceDataGenerateZipFailedHandler handler;
    ...
    void execute() throws Exception {
        ...
        verify(execution, times(1)).setVariable(
                CcaBpmnProcessConstants.PERFORMANCE_DATA_DOWNLOAD_ZIP_FILE, null);
        verify(execution, times(1)).setVariable(
