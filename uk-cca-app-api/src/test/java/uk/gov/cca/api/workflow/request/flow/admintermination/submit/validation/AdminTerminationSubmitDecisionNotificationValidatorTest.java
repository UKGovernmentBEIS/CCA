...
class AdminTerminationSubmitDecisionNotificationValidatorTest {
    ...
    void validate() {
        ...
        // Invoke
        BusinessValidationResult result = adminTerminationSubmitDecisionNotificationValidator
    ...
    void validate_not_valid() {
        ...
        when(validator.validate(decisionNotification)).thenReturn(Optional.of(new BusinessViolation()));
        when(ccaDecisionNotificationUsersValidator.validate(requestTask, decisionNotification, appUser))
    ...
    @Test
    void getSectionName() {
        assertThat(adminTerminationSubmitDecisionNotificationValidator.getSectionName())
                .isEqualTo(AdminTerminationReasonDetails.class.getName());
    }
}
