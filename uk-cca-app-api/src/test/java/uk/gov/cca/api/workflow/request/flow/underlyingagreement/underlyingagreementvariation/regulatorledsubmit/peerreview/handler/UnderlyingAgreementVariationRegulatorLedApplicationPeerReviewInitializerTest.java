...
class UnderlyingAgreementVariationRegulatorLedApplicationPeerReviewInitializerTest {

    @InjectMocks
    private UnderlyingAgreementVariationRegulatorLedApplicationPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        final UnderlyingAgreementVariationRegulatorLedPeerReviewRequestTaskPayload expected =
                UnderlyingAgreementVariationRegulatorLedPeerReviewRequestTaskPayload.builder()
                        .payloadType(CcaRequestTaskPayloadType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEW_PAYLOAD)
                        .accountReferenceData(accountReferenceData)
        ...
        // Verify
        assertThat(result)
                .isInstanceOf(UnderlyingAgreementVariationRegulatorLedPeerReviewRequestTaskPayload.class)
                .isEqualTo(expected);
