...
import uk.gov.cca.api.workflow.request.flow.underlyingagreementvariation.common.service.UnderlyingAgreementVariationSectionUploadAttachmentService;
...
class UnderlyingAgreementVariationSectionUploadAttachmentHandlerTest {

    @InjectMocks
    private UnderlyingAgreementVariationSectionUploadAttachmentHandler handler;
    ...
    void getType() {
        assertThat(handler.getType())
                .isEqualTo(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_UPLOAD_SECTION_ATTACHMENT);
    }
}