...
class NonComplianceClosedHandlerFlowableTest {

    @InjectMocks
    private NonComplianceClosedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(nonComplianceCloseService, times(1)).close(requestId);
    }
