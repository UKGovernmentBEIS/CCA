...
class RequestTaskViewServiceTest {
    ...
    void getTaskItemInfo() {
        ...
        final RequestTaskType requestTaskType = RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW;
    ...
    public void getRequestTasks() {
        final String user = "user";
        final AppUser appUser = AppUser.builder().userId(user).firstName("fn").lastName("ln").roleType(RoleType.REGULATOR).build();
        Set<String> expectedResourceScopePermissions = Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW.toString());
        ...
        assertThat(actualRequestTasks).containsAll(Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW));
    }
