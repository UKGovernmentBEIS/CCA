...
class UnderlyingAgreementVariationFirstReminderDateReachedHandlerFlowableTest {

    @InjectMocks
    private UnderlyingAgreementVariationFirstReminderDateReachedHandlerFlowable handler;
    @Mock
