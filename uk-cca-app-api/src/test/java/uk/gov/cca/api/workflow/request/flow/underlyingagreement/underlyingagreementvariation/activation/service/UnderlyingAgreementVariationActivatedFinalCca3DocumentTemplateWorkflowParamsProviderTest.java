...
class UnderlyingAgreementVariationActivatedFinalCca3DocumentTemplateWorkflowParamsProviderTest {

    @InjectMocks
    private UnderlyingAgreementVariationActivatedFinalCca3DocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
        ...
        when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, activationDate, SchemeVersion.CCA_3, version + 1))
        ...
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
                .constructTemplateParams(una, activationDate, SchemeVersion.CCA_3, version + 1);
    }
}
