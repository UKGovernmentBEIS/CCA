package uk.gov.cca.api.workflow.request.flow.underlyingagreement.underlyingagreementvariation.activation.validation;
...
class UnderlyingAgreementVariationActivationNotifyOperatorValidatorTest {

    @InjectMocks
    private UnderlyingAgreementVariationActivationNotifyOperatorValidator validator;

    @Mock
    private UnderlyingAgreementVariationActivationSubmitValidator underlyingAgreementActivationSubmitValidator;
    ...
    void validate_not_valid() {
        ...
        // Verify
        assertThat(businessException.getErrorCode()).isEqualTo(CcaErrorCode.INVALID_UNDERLYING_AGREEMENT_VARIATION_ACTIVATION);
        verify(underlyingAgreementActivationSubmitValidator, times(1))
                .validate(taskPayload);
        verify(decisionNotificationValidator, times(1))
                .validateDecisionNotification(requestTask, decisionNotification, user);
