...
class AdminTerminationUpdateAccountHandlerFlowableTest {

	@InjectMocks
    private AdminTerminationUpdateAccountHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(adminTerminationFinalisedService, times(1)).terminateAccountAndOpenWorkflows(requestId);
