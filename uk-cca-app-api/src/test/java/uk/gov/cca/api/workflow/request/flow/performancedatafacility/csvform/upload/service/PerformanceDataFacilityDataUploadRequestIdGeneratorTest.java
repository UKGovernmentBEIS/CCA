...
class PerformanceDataFacilityDataUploadRequestIdGeneratorTest {

    @InjectMocks
    private PerformanceDataFacilityDataUploadRequestIdGenerator generator;
    ...
    void generateRequestId() {
        ...
        assertThat(result).isEqualTo("ADS_1-TPR-2");
    }

    @Test
    void getTypes() {
        assertThat(generator.getTypes()).containsExactly(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD);
    }
