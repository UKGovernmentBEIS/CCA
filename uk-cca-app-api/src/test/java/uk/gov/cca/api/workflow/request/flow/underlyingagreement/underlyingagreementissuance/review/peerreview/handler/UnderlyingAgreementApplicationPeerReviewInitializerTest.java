...
class UnderlyingAgreementApplicationPeerReviewInitializerTest {

    @InjectMocks
    UnderlyingAgreementApplicationPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType())
                .isEqualTo(CcaRequestTaskPayloadType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(UnderlyingAgreementPeerReviewRequestTaskPayload.class);
        assertThat(((UnderlyingAgreementPeerReviewRequestTaskPayload) requestTaskPayload).getDetermination())
                .isEqualTo(requestPayload.getDetermination());
        assertThat(((UnderlyingAgreementPeerReviewRequestTaskPayload) requestTaskPayload).getSectionsCompleted())
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
                .containsExactly(CcaRequestTaskType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEW);
    }
}
