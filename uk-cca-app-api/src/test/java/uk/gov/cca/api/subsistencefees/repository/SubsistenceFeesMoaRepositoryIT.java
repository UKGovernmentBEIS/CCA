...
class SubsistenceFeesMoaRepositoryIT extends AbstractContainerBaseTest {

	@Autowired
    private SubsistenceFeesMoaRepository repository;
    ...
    @Test
    void getMoaDetailsById_sector_and_tu_moa() {
    	SubsistenceFeesMoaDetails details1 = new SubsistenceFeesMoaDetails(
    			1L, "CCACM1200", MoaType.SECTOR_MOA, 1L, new BigDecimal("400.00"), new BigDecimal("2000.00"), 
    			"111-111-111", submissionDate, new BigDecimal("100.00"), new BigDecimal("300.00"), 3L, 2L, null);
    	SubsistenceFeesMoaDetails details2 = new SubsistenceFeesMoaDetails(
    			3L, "CCATM1200", MoaType.TARGET_UNIT_MOA, 40L, new BigDecimal("200.00"), new BigDecimal("1.00"), 
    			"111-111-111", submissionDate, new BigDecimal("100.00"), new BigDecimal("100.00"), 1L, 0L, 5L);
