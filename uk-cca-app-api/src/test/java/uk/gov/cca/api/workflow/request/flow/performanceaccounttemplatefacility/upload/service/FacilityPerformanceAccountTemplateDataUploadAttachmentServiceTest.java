...
class FacilityPerformanceAccountTemplateDataUploadAttachmentServiceTest {

    @InjectMocks
    private FacilityPerformanceAccountTemplateDataUploadAttachmentService service;
    ...
    void uploadAttachment() {
        ...
        // Verify
        assertThat(((FacilityPerformanceAccountTemplateDataUploadSubmitRequestTaskPayload) requestTask.getPayload()).getUploadAttachments())
                .hasSize(2);
