...
class UnderlyingAgreementActivatedFinalDocumentTemplateWorkflowParamsProviderTest {
    ...
    void constructParams() {
        ...
        when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, activationDate, version))
        ...
        verify(documentTemplateTransformationMapper, times(1))
                .formatCurrentDate();
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
                .constructTemplateParams(una, activationDate, version);
    }
}
