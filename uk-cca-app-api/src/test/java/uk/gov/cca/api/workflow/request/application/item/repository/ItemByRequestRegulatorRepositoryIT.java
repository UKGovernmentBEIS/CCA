...
class ItemByRequestRegulatorRepositoryIT extends AbstractContainerBaseTest {
    ...
    void findItemsByRequestId() {
        Map<CompetentAuthorityEnum, Set<RequestTaskType>> scopedRequestTaskTypes =
                Map.of(CompetentAuthorityEnum.ENGLAND, Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, RequestTaskType.DUMMY_REQUEST_TASK_TYPE2));

        Request request1 = createRequest(1L, RequestType.DUMMY_REQUEST_TYPE, RequestStatus.IN_PROGRESS, CompetentAuthorityEnum.ENGLAND, LocalDateTime.now());
        RequestTask requestTask1 = createRequestTask("oper1", request1, RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, "t1", LocalDateTime.now());
        RequestTask requestTask2 = createRequestTask("oper1", request1, RequestTaskType.DUMMY_REQUEST_TASK_TYPE2, "t2", LocalDateTime.now());

        Request request2 = createRequest(2L, RequestType.DUMMY_REQUEST_TYPE, RequestStatus.IN_PROGRESS, CompetentAuthorityEnum.SCOTLAND, LocalDateTime.now().plusDays(1));
        createRequestTask("oper1", request2, RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW, "t4", LocalDateTime.now());
