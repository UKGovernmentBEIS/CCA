...
class UnderlyingAgreementAcceptedProposedCca2DocumentTemplateWorkflowParamsProviderTest {

    @InjectMocks
    private UnderlyingAgreementAcceptedProposedCca2DocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
        ...
        when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, null, SchemeVersion.CCA_2, version))
        ...
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
                .constructTemplateParams(una, null, SchemeVersion.CCA_2, version);
    }
}
