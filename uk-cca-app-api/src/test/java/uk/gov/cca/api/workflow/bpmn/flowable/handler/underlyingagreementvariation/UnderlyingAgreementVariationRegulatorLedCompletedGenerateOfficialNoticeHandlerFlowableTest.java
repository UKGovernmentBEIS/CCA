...
class UnderlyingAgreementVariationRegulatorLedCompletedGenerateOfficialNoticeHandlerFlowableTest {

    @InjectMocks
    private UnderlyingAgreementVariationRegulatorLedCompletedGenerateOfficialNoticeHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(underlyingAgreementVariationOfficialNoticeService,times(1))
                .generateAndSaveCompletedOfficialNotice(requestId);
    }
}
