...
class PerformanceDataFacilityDigitalFormCalculateResultsActionHandlerTest {

    @InjectMocks
    private PerformanceDataFacilityDigitalFormCalculateResultsActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.PERFORMANCE_DATA_FACILITY_DIGITAL_FORM_CALCULATE_RESULTS;
        ...
        verify(performanceDataFacilityDigitalFormSubmitService, times(1)).calculate(requestTask);
    }

    @Test
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.PERFORMANCE_DATA_FACILITY_DIGITAL_FORM_CALCULATE_RESULTS);
    }
}
