...
class AuditDetailsCorrectiveActionsSubmitSaveActionHandlerTest {

    @InjectMocks
    private AuditDetailsCorrectiveActionsSubmitSaveActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.FACILITY_AUDIT_AUDIT_DETAILS_CORRECTIVE_ACTIONS_SAVE_APPLICATION;
        final AuditDetailsCorrectiveActionsSubmitSaveRequestTaskActionPayload taskActionPayload =
                AuditDetailsCorrectiveActionsSubmitSaveRequestTaskActionPayload.builder().build();
        ...
        verify(auditDetailsCorrectiveActionsSubmitService, times(1))
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.FACILITY_AUDIT_AUDIT_DETAILS_CORRECTIVE_ACTIONS_SAVE_APPLICATION);
    }
}
