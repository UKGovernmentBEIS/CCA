package uk.gov.cca.api.workflow.request.application.accountcontactassigned;
...
import uk.gov.cca.api.workflow.request.application.accountcontactassigned.FirstPrimaryContactAssignedToAccountEventService;
...
public class FirstPrimaryContactAssignedToAccountEventServiceTest {
    ...
    void assignUnassignedTasksToAccountPrimaryContact() {
        ...
        ).thenReturn(Set.of(RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW.toString()));
