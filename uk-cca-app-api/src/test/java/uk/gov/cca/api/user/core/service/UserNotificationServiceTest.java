...
import static uk.gov.cca.api.notification.mail.constants.EmailNotificationTemplateConstants.OPERATOR_INVITATION_CONFIRMATION_LINK;
...
import static uk.gov.cca.api.user.NavigationOutcomes.OPERATOR_REGISTRATION_INVITATION_ACCEPTED_URL;
...
class UserNotificationServiceTest {
    ...
    void notifyUserReset2Fa() {
        ...
        NotificationProperties.Email notificationEmail = mock(NotificationProperties.Email.class);
        when(notificationProperties.getEmail()).thenReturn(notificationEmail);
        when(notificationEmail.getCcaHelpdesk()).thenReturn(helpdesk);
        ...
        EmailData emailInfo = EmailData.builder()
                .notificationTemplateData(EmailNotificationTemplateData.builder()
                        ...
                        .templateParams(Map.of(
                        		EmailNotificationTemplateConstants.HOME_URL, url,
                        		EmailNotificationTemplateConstants.CCA_HELPDESK, helpdesk))
                        .build())
                .build();
    ...
    private AppProperties.Web createAppWeb() {
        ...
        web.setUrl("http://www.netz.org.uk");
        return web;
    }
}
