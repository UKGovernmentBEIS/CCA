...
class UnderlyingAgreementActivatedFinalCca2DocumentTemplateWorkflowParamsProviderTest {

    @InjectMocks
    private UnderlyingAgreementActivatedFinalCca2DocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
        ...
        when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, activationDate, SchemeVersion.CCA_2, version))
        ...
        verify(documentTemplateTransformationMapper, times(1))
                .formatCurrentDate();
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
                .constructTemplateParams(una, activationDate, SchemeVersion.CCA_2, version);
    }
}
