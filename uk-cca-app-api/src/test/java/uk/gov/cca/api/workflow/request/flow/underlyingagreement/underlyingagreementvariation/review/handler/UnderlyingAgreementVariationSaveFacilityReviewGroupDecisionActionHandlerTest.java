...
class UnderlyingAgreementVariationSaveFacilityReviewGroupDecisionActionHandlerTest {

    @InjectMocks
    private UnderlyingAgreementVariationSaveFacilityReviewGroupDecisionActionHandler handler;
    ...
    void process() {
        ...
        verify(underlyingAgreementVariationReviewService, times(1)).saveFacilityReviewGroupDecision(payload, requestTask);
    }

    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_SAVE_FACILITY_REVIEW_GROUP_DECISION);
    }
}
