...
import uk.gov.cca.api.workflow.request.application.item.service.ItemUnassignedVerifierService;
...
class ItemUnassignedVerifierServiceTest {
    ...
    void getUnassignedItems() {
        Map<Long, Set<RequestTaskType>> scopedRequestTaskTypes = Map.of(1L, Set.of(mock(RequestTaskType.class)));
        ...
        // Invoke
        ItemDTOResponse actualResponse = service.getUnassignedItems(appUser, PagingRequest.builder().pageNumber(0L).pageSize(10L).build());
