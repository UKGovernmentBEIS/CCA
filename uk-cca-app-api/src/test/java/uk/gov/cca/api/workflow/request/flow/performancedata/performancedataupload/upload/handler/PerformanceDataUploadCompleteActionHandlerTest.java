...
class PerformanceDataUploadCompleteActionHandlerTest {

    @InjectMocks
    private PerformanceDataUploadCompleteActionHandler handler;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.PERFORMANCE_DATA_UPLOAD_COMPLETE;
    ...
    @Test
    void getTypes() {
        assertThat(handler.getTypes()).containsExactly(CcaRequestTaskActionType.PERFORMANCE_DATA_UPLOAD_COMPLETE);
    }
}
