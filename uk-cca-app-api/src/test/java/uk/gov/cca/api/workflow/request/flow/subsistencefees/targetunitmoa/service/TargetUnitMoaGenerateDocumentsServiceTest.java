...
class TargetUnitMoaGenerateDocumentsServiceTest {
    ...
    void generateDocuments() {
        Request request = Request.builder()
                .payload(TargetUnitMoaRequestPayload.builder().build())
                .build();
        ...
        when(targetUnitMoaCreateDocumentService.create(request, facilities))
        ...
        // verify
        verify(targetUnitMoaCreateDocumentService, times(1)).create(request, facilities);

        TargetUnitMoaRequestPayload requestPayload = (TargetUnitMoaRequestPayload) request.getPayload();
        assertThat(requestPayload.getTargetUnitMoaDocument()).isEqualTo(document);
    }
    ...
    void generateDocuments_throws_internal_server_error_exception() {
        ...
        when(targetUnitMoaCreateDocumentService.create(request, facilities)).thenAnswer(answer -> {
        ...
        TargetUnitMoaRequestPayload requestPayload = (TargetUnitMoaRequestPayload) request.getPayload();
        assertThat(requestPayload.getTargetUnitMoaDocument()).isNull();
    }
}
