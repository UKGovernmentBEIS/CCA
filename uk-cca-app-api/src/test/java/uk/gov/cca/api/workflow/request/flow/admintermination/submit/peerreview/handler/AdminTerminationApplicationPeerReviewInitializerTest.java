...
class AdminTerminationApplicationPeerReviewInitializerTest {

    @InjectMocks
    AdminTerminationApplicationPeerReviewInitializer initializer;
    ...
    void initializePayload() {
        ...
        assertThat(requestTaskPayload.getPayloadType())
                .isEqualTo(CcaRequestTaskPayloadType.ADMIN_TERMINATION_PEER_REVIEW_PAYLOAD);
        assertThat(requestTaskPayload).isInstanceOf(AdminTerminationPeerReviewRequestTaskPayload.class);
        assertThat(((AdminTerminationPeerReviewRequestTaskPayload) requestTaskPayload).getAdminTerminationReasonDetails())
                .isEqualTo(requestPayload.getAdminTerminationReasonDetails());
        assertThat(((AdminTerminationPeerReviewRequestTaskPayload) requestTaskPayload).getSectionsCompleted())
    ...
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
                .containsExactly(CcaRequestTaskType.ADMIN_TERMINATION_APPLICATION_PEER_REVIEW);
    }
}
