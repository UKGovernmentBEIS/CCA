...
class PerformanceDataSpreadsheetProcessingCompletedHandlerTest {

    @InjectMocks
    private PerformanceDataSpreadsheetProcessingCompletedHandler handler;
    ...
    void execute() throws Exception {
        ...
        final TargetUnitAccountUploadReport accountReport = TargetUnitAccountUploadReport.builder().accountId(1L).build();
        ...
        when(execution.getVariable(CcaBpmnProcessConstants.PERFORMANCE_DATA_UPLOAD_PROCESSING_NUMBER_OF_ACCOUNTS_COMPLETED))
                .thenReturn(0);
        ...
        verify(performanceDataProcessingCompletedService, times(1))
        ...
        verify(execution, times(1))
                .setVariable(CcaBpmnProcessConstants.PERFORMANCE_DATA_UPLOAD_PROCESSING_NUMBER_OF_ACCOUNTS_COMPLETED, 1);
    }
}
