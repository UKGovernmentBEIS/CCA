package uk.gov.cca.api.verificationbody.repository;
...
import static uk.gov.cca.api.common.EmissionTradingScheme.DUMMY_EMISSION_TRADING_SCHEME;
import static uk.gov.cca.api.common.EmissionTradingScheme.DUMMY_EMISSION_TRADING_SCHEME_2;
...
class VerificationBodyRepositoryIT extends AbstractContainerBaseTest {
    ...
    void findActiveVerificationBodiesAccreditedToType() {
        createVerificationBody("vb1", "accredRefNum1",
            VerificationBodyStatus.ACTIVE, Set.of(DUMMY_EMISSION_TRADING_SCHEME));

        createVerificationBody("vb2", "accredRefNum2",
            VerificationBodyStatus.ACTIVE, Set.of(DUMMY_EMISSION_TRADING_SCHEME_2));

        createVerificationBody("vb3", "accredRefNum3",
            VerificationBodyStatus.DISABLED, Set.of(DUMMY_EMISSION_TRADING_SCHEME_2));

        flushAndClear();

        EmissionTradingScheme vbType = DUMMY_EMISSION_TRADING_SCHEME;
    ...
    void findByIdEagerEmissionTradingSchemes() {
        Set<EmissionTradingScheme> emissionTradingSchemes = Set.of(
                DUMMY_EMISSION_TRADING_SCHEME,
                DUMMY_EMISSION_TRADING_SCHEME_2
        );
        ...
        assertThat(result.get().getEmissionTradingSchemes()).
            containsExactlyInAnyOrder(DUMMY_EMISSION_TRADING_SCHEME, DUMMY_EMISSION_TRADING_SCHEME_2);
    }
    ...
    void isVerificationBodyAccreditedToEmissionTradingScheme_return_true() {
        ...
        assertThat(repo.isVerificationBodyAccreditedToEmissionTradingScheme(vb.getId(), DUMMY_EMISSION_TRADING_SCHEME)).isTrue();
    }
