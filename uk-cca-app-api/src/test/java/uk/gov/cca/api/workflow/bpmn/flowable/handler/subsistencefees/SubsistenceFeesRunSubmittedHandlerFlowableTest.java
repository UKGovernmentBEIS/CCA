...
class SubsistenceFeesRunSubmittedHandlerFlowableTest {

	@InjectMocks
    private SubsistenceFeesRunSubmittedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(service, times(1)).subsistenceFeesRunSubmitted(requestId);
    }
}
