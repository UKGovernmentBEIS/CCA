...
class FacilityPerformanceAccountTemplateDataProcessingCompletedHandlerFlowableTest {

    @InjectMocks
    private FacilityPerformanceAccountTemplateDataProcessingCompletedHandlerFlowable handler;
    ...
    void execute() {
        ...
        final Request request = Request.builder()
                .payload(FacilityPerformanceAccountTemplateDataProcessingRequestPayload.builder()
                        .facilityReports(Map.of(1L, FacilityPerformanceAccountTemplateUploadReport.builder().facilityId(1L).build()))
                        .build())
                .build();
        ...
        verify(execution, times(1)).setVariable(CcaBpmnProcessConstants.FACILITY_PERFORMANCE_ACCOUNT_TEMPLATE_DATA_PROCESSING_MESSAGE_FAILED, false);
