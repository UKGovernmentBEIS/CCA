...
import static uk.gov.netz.api.common.exception.ErrorCode.AUTHORITY_USER_NOT_RELATED_TO_CA;
...
class RegulatorAuthorityUpdateServiceTest {
    ...
    void updateRegulatorUserPermissions() {
        ...
        Map<String, RegulatorPermissionLevel> newAuthorityPermissions = Map.of(MANAGE_USERS_AND_CONTACTS, EXECUTE);
    ...
    private AppUser buildRegulatorUser(String userId, CompetentAuthorityEnum ca, String...permissions) {
