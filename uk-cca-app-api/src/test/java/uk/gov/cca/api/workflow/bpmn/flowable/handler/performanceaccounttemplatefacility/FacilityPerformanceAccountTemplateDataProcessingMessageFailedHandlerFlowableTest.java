...
class FacilityPerformanceAccountTemplateDataProcessingMessageFailedHandlerFlowableTest {

    @InjectMocks
    private FacilityPerformanceAccountTemplateDataProcessingMessageFailedHandlerFlowable handler;
    ...
    void execute() {
        ...
        verify(facilityPerformanceAccountTemplateDataUploadCompleteService, times(1)).processMessageFailed(requestId);
    }
}
