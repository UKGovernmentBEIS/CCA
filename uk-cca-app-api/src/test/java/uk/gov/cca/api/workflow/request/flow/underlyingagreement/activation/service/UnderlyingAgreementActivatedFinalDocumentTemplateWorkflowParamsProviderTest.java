...
class UnderlyingAgreementActivatedFinalDocumentTemplateWorkflowParamsProviderTest {

	@InjectMocks
    private UnderlyingAgreementActivatedFinalDocumentTemplateWorkflowParamsProvider provider;
    ...
    void constructParams() {
		...
		when(documentTemplateUnderlyingAgreementParamsProvider.constructTemplateParams(una, Set.of(), activationDate, version))
		...
		verify(documentTemplateTransformationMapper, times(1))
				.formatCurrentDate();
        verify(documentTemplateUnderlyingAgreementParamsProvider, times(1))
				.constructTemplateParams(una, Set.of(), activationDate, version);
    }
}
