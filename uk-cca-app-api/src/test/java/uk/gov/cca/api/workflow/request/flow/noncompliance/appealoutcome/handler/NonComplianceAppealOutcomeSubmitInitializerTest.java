...
class NonComplianceAppealOutcomeSubmitInitializerTest {

    @InjectMocks
    private NonComplianceAppealOutcomeSubmitInitializer initializer;
    ...
    void initializePayload() {
        ...
        final NonComplianceAppealOutcomeSubmitRequestTaskPayload expected = NonComplianceAppealOutcomeSubmitRequestTaskPayload.builder()
        ...
        // Verify
        assertThat(actual).isInstanceOf(NonComplianceAppealOutcomeSubmitRequestTaskPayload.class).isEqualTo(expected);
    }

    @Test
    void getRequestTaskTypes() {
        assertThat(initializer.getRequestTaskTypes())
                .containsExactly(CcaRequestTaskType.NON_COMPLIANCE_APPEAL_OUTCOME_SUBMIT);
    }
}