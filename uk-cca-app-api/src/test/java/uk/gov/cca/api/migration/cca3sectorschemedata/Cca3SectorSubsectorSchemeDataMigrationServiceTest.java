...
class Cca3SectorSubsectorSchemeDataMigrationServiceTest {

	@InjectMocks
	private Cca3SectorSubsectorSchemeDataMigrationService service;
	...
	void migrateSectorAssociationToCca3Scheme() {
		...
		UpdateSectorAssociationSchemeDataVO input = UpdateSectorAssociationSchemeDataVO.builder()
				.sectorAcronym("SEC")
				.subsectorName("")
