...
class UnderlyingAgreementVariationReviewRequestPeerReviewActionHandlerTest {

    @InjectMocks
    private UnderlyingAgreementVariationReviewRequestPeerReviewActionHandler handler;

    @Mock
    private RequestTaskService requestTaskService;

    @Mock
    private UnderlyingAgreementVariationReviewRequestPeerReviewValidator underlyingAgreementVariationReviewRequestPeerReviewValidator;
    ...
    void process() {
        ...
        final String requestTaskActionType = CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_REQUEST_PEER_REVIEW;
        ...
        final PeerReviewRequestTaskActionPayload taskActionPayload = PeerReviewRequestTaskActionPayload.builder()
                .payloadType(CcaRequestTaskActionPayloadType.UNDERLYING_AGREEMENT_VARIATION_PEER_REVIEW_REQUEST_PAYLOAD)
        ...
        verify(underlyingAgreementVariationReviewRequestPeerReviewValidator, times(1)).validate(requestTask, taskActionPayload, appUser);
        verify(underlyingAgreementReviewService, times(1)).requestPeerReview(requestTask, peerReviewer, regulatorReviewer);
        verify(requestService, times(1))
                .addActionToRequest(request, null, CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_APPLICATION_PEER_REVIEW_REQUESTED, regulatorReviewer);
    ...
    void getTypes() {
        assertThat(handler.getTypes())
                .containsExactly(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_REQUEST_PEER_REVIEW);
    }
}
