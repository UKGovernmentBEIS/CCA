...
import uk.gov.cca.api.account.service.validator.AccountStatusAspect;
...
class AccountStatusAspectTest {
    ...
    public static class AccountValidTest {
        @uk.gov.cca.api.account.service.validator.AccountStatus(expression = "{#status == 'TEST_ACCOUNT_STATUS_A'}")
