...
class CcaPeerReviewUploadAttachmentHandlerTest {

    @InjectMocks
    private CcaPeerReviewUploadAttachmentHandler handler;
    ...
    void uploadAttachment() {
        ...
        // Verify
        verify(peerReviewUploadAttachmentService, times(1))
    ...
    void getType() {
        assertThat(handler.getType())
                .isEqualTo(CcaRequestTaskActionType.PEER_REVIEW_UPLOAD_ATTACHMENT);
    }
}
