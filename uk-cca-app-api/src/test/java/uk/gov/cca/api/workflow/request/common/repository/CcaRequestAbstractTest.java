package uk.gov.cca.api.workflow.request.common.repository;
...
public abstract class CcaRequestAbstractTest extends AbstractContainerBaseTest {
	...
	protected Request createRequest(Map<String, String> resources, RequestType requestType, String processInstanceId, 
			String status, LocalDateTime creationDate) {
		return createRequest(resources, requestType, processInstanceId, status, creationDate, WorkflowEngineType.CAMUNDA);
	}

	protected Request createRequest(Map<String, String> resources, RequestType requestType, 
			String processInstanceId, String status, LocalDateTime creationDate, WorkflowEngineType engine) {
        Request request = Request.builder()
                ...
                .build();
        addResourcesToRequest(resources, request);
	...
	protected void addResourcesToRequest(Map<String, String> resources, Request request) {
		resources.forEach((resourceType, resourceId) -> {
			RequestResource resource = RequestResource.builder()
					.resourceType(resourceType)
