...
class UnderlyingAgreementSectionUploadAttachmentServiceTest {
    ...
    void uploadAttachment() {
        ...
        // Verify
        assertThat(((UnderlyingAgreementRequestTaskPayload) requestTask.getPayload()).getUnderlyingAgreementAttachments())
                .hasSize(2);
