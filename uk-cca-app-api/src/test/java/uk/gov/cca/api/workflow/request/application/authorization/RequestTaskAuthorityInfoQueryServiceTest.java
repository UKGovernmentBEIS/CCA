...
import uk.gov.cca.api.workflow.request.application.authorization.RequestTaskAuthorityInfoQueryService;
...
class RequestTaskAuthorityInfoQueryServiceTest {
    ...
    void getRequestTaskInfo() {
        Request request = createRequest(DUMMY_REQUEST_TYPE);
        RequestTask requestTask = createRequestTask(request, PROCESS_TASK_ID, RequestTaskType.DUMMY_REQUEST_TYPE_APPLICATION_REVIEW.toString(), "assignee");
    ...
    private Request createRequest(RequestType requestType) {
