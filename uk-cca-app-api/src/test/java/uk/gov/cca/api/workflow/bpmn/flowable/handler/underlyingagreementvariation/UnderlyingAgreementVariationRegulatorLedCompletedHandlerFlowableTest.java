...
class UnderlyingAgreementVariationRegulatorLedCompletedHandlerFlowableTest {

    @InjectMocks
    private UnderlyingAgreementVariationRegulatorLedCompletedHandlerFlowable handler;
