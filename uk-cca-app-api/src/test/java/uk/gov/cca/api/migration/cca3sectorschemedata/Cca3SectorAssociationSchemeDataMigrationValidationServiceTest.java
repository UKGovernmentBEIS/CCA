...
class Cca3SectorAssociationSchemeDataMigrationValidationServiceTest {

	@InjectMocks
	private Cca3SectorAssociationSchemeDataMigrationValidationService validationService;

	@Mock
	private SectorAssociationQueryService sectorAssociationQueryService;

	@Mock
	private DataValidator<Cca3SectorAssociationSchemeDataVO> validator;

	@Test
	void validate() {
		List<String> failedEntries = new ArrayList<>();
		final LocalDate umaDate = java.time.LocalDate.of(2023, 11, 28);
		final Cca3SectorAssociationSchemeDataVO vo = Cca3SectorAssociationSchemeDataVO.builder()
				.sectorAcronym("ADS_1")
				.subsectorName("")
