...
public class RegulatorUserInvitationController {
    ...
    @ApiResponse(responseCode = "400", description = SwaggerApiInfo.INVITE_REGULATOR_USER_TO_CA_BAD_REQUEST,
    ...
    public ResponseEntity<Void> inviteRegulatorUserToCA(
            ...
            @RequestPart(value = "signature") @Parameter(description = "The signature file") MultipartFile signature) throws IOException {
