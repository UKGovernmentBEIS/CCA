...
import uk.gov.cca.api.notification.mail.domain.EmailRecipients;
import uk.gov.cca.api.notification.template.domain.NotificationContent;
import uk.gov.cca.api.notification.template.service.NotificationTemplateProcessService;
...
public class NotificationEmailServiceImpl implements NotificationEmailService {
    ...
    @Override
    public void notifyRecipients(EmailData emailData, List<String> recipientsEmails) {
    ...
    @Override
    public void notifyRecipients(EmailData emailData, List<String> recipientsEmails, List<String> ccRecipientsEmails, List<String> bccRecipientsEmails) {
