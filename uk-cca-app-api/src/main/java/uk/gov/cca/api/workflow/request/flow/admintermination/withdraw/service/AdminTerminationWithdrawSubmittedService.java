...
public class AdminTerminationWithdrawSubmittedService {
    ...
    public void submit(final String requestId) {
        ...
        final AdminTerminationWithdrawSubmittedRequestActionPayload actionPayload =
                AdminTerminationWithdrawSubmittedRequestActionPayload.builder()
                        ...
                        .adminTerminationWithdrawReasonDetails(requestPayload.getAdminTerminationWithdrawReasonDetails())
                        .decisionNotification(ccaDecisionNotification)
                        .adminTerminationWithdrawAttachments(requestPayload.getAdminTerminationWithdrawAttachments())
                        .usersInfo(usersInfo)
        ...
        requestService.addActionToRequest(request,
                actionPayload,
                CcaRequestActionType.ADMIN_TERMINATION_WITHDRAW_APPLICATION_SUBMITTED,
