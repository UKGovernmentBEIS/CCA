...
public class MoaCompletedService {
	...
	public void completed(
			String requestId, Long resourceId, MoaType moaType, String moaRequestId, Boolean succeeded, List<String> errors, boolean lock) {
		final Request request = lock ? requestService.findRequestByIdForUpdate(requestId)
