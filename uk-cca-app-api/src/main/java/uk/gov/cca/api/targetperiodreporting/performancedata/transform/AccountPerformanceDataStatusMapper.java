...
import uk.gov.cca.api.targetperiodreporting.performancedata.domain.dto.AccountPerformanceDataStatusDTO;
...
public interface AccountPerformanceDataStatusMapper {
	...
	AccountPerformanceDataStatusDTO toDto(AccountPerformanceDataStatus entity);

	AccountPerformanceDataStatus toEntity(AccountPerformanceDataStatusDTO dto);
