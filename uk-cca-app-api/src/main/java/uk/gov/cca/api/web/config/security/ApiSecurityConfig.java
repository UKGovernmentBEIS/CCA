package uk.gov.cca.api.web.config.security;
...
import uk.gov.cca.api.web.security.ApplicationAuthenticationConverter;
import uk.gov.cca.api.web.security.RoleTypeClaimConverter;
