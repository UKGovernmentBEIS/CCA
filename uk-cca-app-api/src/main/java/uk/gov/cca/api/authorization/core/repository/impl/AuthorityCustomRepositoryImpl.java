...
import uk.gov.cca.api.authorization.core.repository.AuthorityCustomRepository;
import uk.gov.cca.api.authorization.operator.domain.OperatorUserAssignedSubResource;
import uk.gov.cca.api.authorization.regulator.domain.RegulatorUserAssignedSubResource;
import uk.gov.cca.api.authorization.verifier.domain.VerifierUserAssignedSubResource;
...
public class AuthorityCustomRepositoryImpl implements AuthorityCustomRepository {
    ...
    @Override
    public Map<CompetentAuthorityEnum, Set<String>> findResourceSubTypesRegulatorUserHasScope(String userId, String resourceType, String scope) {
        return
    ...
    @Override
    public Map<Long, Set<String>> findResourceSubTypesVerifierUserHasScope(String userId, String resourceType, String scope) {
