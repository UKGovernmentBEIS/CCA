...
@Service
public class AdminTerminationFinalDecisionNotificationValidator extends AdminTerminationDecisionNotificationValidator {

    public AdminTerminationFinalDecisionNotificationValidator(DataValidator<CcaDecisionNotification> validator,
                                                              CcaDecisionNotificationUsersValidator ccaDecisionNotificationUsersValidator) {
        super(validator, ccaDecisionNotificationUsersValidator);
    }

    @Override
    protected String getSectionName() {
        return AdminTerminationFinalDecisionReasonDetails.class.getName();
    }
