...
public class AuthService {
    ...
    public void enablePendingUser(String userId, String userPassword) {
        setPasswordAndEnableUserBasedOnExpectedStatus(userId, userPassword, AuthenticationStatus.PENDING);
    }
    ...
    public UserRepresentation enableRegisteredUser(String userId, String userPassword) {
        return setPasswordAndEnableUserBasedOnExpectedStatus(userId, userPassword, AuthenticationStatus.REGISTERED);
    }
    ...
    public void setPasswordForRegisteredUser(UserRepresentation userRepresentation, String password, String otp, String email) {
        checkUserStatus(userRepresentation, AuthenticationStatus.REGISTERED);
    ...
    private UserRepresentation setPasswordAndEnableUserBasedOnExpectedStatus(String userId, String password,
        ...
        if (AuthenticationStatus.PENDING.equals(expectedUserAuthenticationStatus)) {
            setUserAsRegisteredAndEnabled(userRepresentation);
        } else if (AuthenticationStatus.REGISTERED.equals(expectedUserAuthenticationStatus)) {
