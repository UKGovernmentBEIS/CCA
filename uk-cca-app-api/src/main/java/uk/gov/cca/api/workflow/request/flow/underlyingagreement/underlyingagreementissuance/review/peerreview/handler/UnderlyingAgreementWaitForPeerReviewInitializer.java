...
@Service
public class UnderlyingAgreementWaitForPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return PEER_REVIEW_MAPPER.toUnderlyingAgreementReviewRequestTaskPayload(requestPayload);
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(CcaRequestTaskType.UNDERLYING_AGREEMENT_WAIT_FOR_PEER_REVIEW);
    }
}