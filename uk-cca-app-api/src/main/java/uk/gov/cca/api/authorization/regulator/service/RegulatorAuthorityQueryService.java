...
import uk.gov.cca.api.authorization.core.transform.UserAuthorityMapper;
...
import static uk.gov.cca.api.authorization.rules.domain.Scope.EDIT_USER;
...
public class RegulatorAuthorityQueryService {
    ...
    public AuthorityManagePermissionDTO getCurrentRegulatorUserPermissions(AppUser appUser) {
        ...
        return AuthorityManagePermissionDTO.builder()
            ...
            .editable(compAuthAuthorizationResourceService.hasUserScopeToCompAuth(appUser, EDIT_USER))
            .build();
    }
    ...
    public UserAuthoritiesDTO getCaAuthorities(AppUser appUser) {
        boolean hasEditUserScopeOnCa = compAuthAuthorizationResourceService.hasUserScopeToCompAuth(appUser, EDIT_USER);
