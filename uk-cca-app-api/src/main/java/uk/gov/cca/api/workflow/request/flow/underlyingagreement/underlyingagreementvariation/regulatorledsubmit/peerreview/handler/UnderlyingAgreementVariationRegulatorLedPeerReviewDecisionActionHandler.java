...
public class UnderlyingAgreementVariationRegulatorLedPeerReviewDecisionActionHandler implements
        RequestTaskActionHandler<CcaPeerReviewDecisionRequestTaskActionPayload> {

    private final RequestTaskService requestTaskService;
    private final RequestService requestService;
    private final UnderlyingAgreementVariationRegulatorLedPeerReviewService underlyingAgreementVariationRegulatorLedPeerReviewService;
    ...
    public RequestTaskPayload process(Long requestTaskId,
        ...
        final CcaPeerReviewDecisionSubmittedRequestActionPayload actionPayload = PEER_REVIEW_MAPPER
                .toPeerReviewDecisionSubmittedRequestActionPayload((CcaPeerReviewDecisionRequestTaskPayload) requestTask.getPayload(),
                        CcaRequestActionPayloadType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_PEER_REVIEW_SUBMITTED_PAYLOAD);

        final String actionType = actionPayload.getDecision().getDecision().getType() == PeerReviewDecisionType.AGREE
                ? CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEWER_ACCEPTED
                : CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_PEER_REVIEWER_REJECTED;

        requestService.addActionToRequest(request, actionPayload, actionType, peerReviewer);
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_SUBMIT_PEER_REVIEW_DECISION);
    }
}
