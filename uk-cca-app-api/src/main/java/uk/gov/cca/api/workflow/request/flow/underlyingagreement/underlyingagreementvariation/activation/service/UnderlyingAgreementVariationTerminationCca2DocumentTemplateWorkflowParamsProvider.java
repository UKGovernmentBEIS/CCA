...
public class UnderlyingAgreementVariationTerminationCca2DocumentTemplateWorkflowParamsProvider implements
    ...
    public String getContextActionType() {
        return CcaDocumentTemplateGenerationContextActionType.UNDERLYING_AGREEMENT_VARIATION_ACTIVATED_SCHEME_TERMINATION_CCA2;
    }

    @Override
    public Map<String, Object> constructParams(UnderlyingAgreementVariationRequestPayload payload) {
        if(!payload.getUnderlyingAgreementVersionMap().containsKey(SchemeVersion.CCA_2)) {
            throw new BusinessException(ErrorCode.RESOURCE_NOT_FOUND);
        }

        final int version = payload.getUnderlyingAgreementVersionMap().get(SchemeVersion.CCA_2);
        ...
        params.put("scheme", SchemeVersion.CCA_2.getDescription());
