...
@NamedQuery(
        ...
        query = "select distinct new uk.gov.cca.api.authorization.rules.domain.AuthorizationRuleScopePermission("
...
public class AuthorizationRule {
    ...
    public static final String NAMED_QUERY_FIND_RULE_SCOPE_PERMISSIONS_BY_SERVICE_AND_ROLE_TYPE_AND_RESOURCE_SUB_TYPE =
            "AuthorizationRule.findRuleScopePermissionsByServiceAndRoleTypeAndResourceSubType";
