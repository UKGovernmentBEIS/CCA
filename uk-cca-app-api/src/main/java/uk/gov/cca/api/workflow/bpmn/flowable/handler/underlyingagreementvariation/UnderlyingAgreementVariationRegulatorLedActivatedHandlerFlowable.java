...
public class UnderlyingAgreementVariationRegulatorLedActivatedHandlerFlowable implements JavaDelegate {

    private final UnderlyingAgreementVariationActivatedService service;
