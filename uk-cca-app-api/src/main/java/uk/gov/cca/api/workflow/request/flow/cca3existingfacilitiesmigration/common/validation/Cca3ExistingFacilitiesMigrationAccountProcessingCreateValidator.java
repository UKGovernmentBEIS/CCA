...
public class Cca3ExistingFacilitiesMigrationAccountProcessingCreateValidator implements RequestCreateByAccountValidator {
    ...
    public RequestCreateValidationResult validateAction(Long accountId) {
        ...
        if(exist) {
           // CCA3_EXISTING_FACILITIES_MIGRATION_ACCOUNT_PROCESSING should not exist
