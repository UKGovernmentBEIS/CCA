...
public class RequestTaskPayloadTypesProvider implements JsonSubTypesProvider {
    ...
    public List<NamedType> getTypes() {
        return List.of(
                ...
                // PAT
				new NamedType(PerformanceAccountTemplateDataUploadSubmitRequestTaskPayload.class,
						CcaRequestTaskPayloadType.PERFORMANCE_ACCOUNT_TEMPLATE_DATA_UPLOAD_SUBMIT_PAYLOAD)        );
    }
