...
@Service
public class AdminTerminationRequestIdGenerator extends AccountRequestSequenceRequestIdGenerator {

	protected TargetUnitAccountRepository targetUnitAccountRepository;
	
	public AdminTerminationRequestIdGenerator(RequestSequenceRepository repository,
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestType.ADMIN_TERMINATION);
    }
