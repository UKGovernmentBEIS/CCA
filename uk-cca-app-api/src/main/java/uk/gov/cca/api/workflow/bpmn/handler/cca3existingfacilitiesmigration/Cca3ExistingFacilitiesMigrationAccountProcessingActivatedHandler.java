...
public class Cca3ExistingFacilitiesMigrationAccountProcessingActivatedHandler implements JavaDelegate {

    private final Cca3ExistingFacilitiesMigrationAccountProcessingActivatedService service;

    @Override
    public void execute(DelegateExecution execution) throws Exception {
        String requestId = (String) execution.getVariable(BpmnProcessConstants.REQUEST_ID);
        service.activateMigratedUnderlyingAgreement(requestId);
    }
}
