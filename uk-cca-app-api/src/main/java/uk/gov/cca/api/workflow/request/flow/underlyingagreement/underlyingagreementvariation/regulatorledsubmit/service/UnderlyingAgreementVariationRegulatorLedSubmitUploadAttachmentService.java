...
public class UnderlyingAgreementVariationRegulatorLedSubmitUploadAttachmentService {
    ...
    public void uploadAttachment(Long requestTaskId, String attachmentUuid, String filename) {
        ...
        UnderlyingAgreementVariationRegulatorLedSubmitRequestTaskPayload requestTaskPayload =
                (UnderlyingAgreementVariationRegulatorLedSubmitRequestTaskPayload) requestTask.getPayload();

        requestTaskPayload.getRegulatorLedSubmitAttachments().put(UUID.fromString(attachmentUuid), filename);
    }
}
