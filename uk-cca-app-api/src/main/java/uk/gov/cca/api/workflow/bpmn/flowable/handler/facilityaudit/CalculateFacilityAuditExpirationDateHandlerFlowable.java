...
public class CalculateFacilityAuditExpirationDateHandlerFlowable implements JavaDelegate {
        ...
        calculateFacilityAuditTrackCorrectiveActionsExpirationRemindersService.calculateExpirationDate(requestId)
                .ifPresentOrElse(
                        ...
                        () -> {
                            ...
                            requestTaskTimeManagementService.setDueDateToTasks(requestId, CcaRequestExpirationKey.FACILITY_AUDIT, null);
                        });
    }
}
