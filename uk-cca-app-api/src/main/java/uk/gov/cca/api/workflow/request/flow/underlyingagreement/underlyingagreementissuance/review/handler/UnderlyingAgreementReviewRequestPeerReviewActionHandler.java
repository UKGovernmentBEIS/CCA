...
public class UnderlyingAgreementReviewRequestPeerReviewActionHandler implements RequestTaskActionHandler<PeerReviewRequestTaskActionPayload> {

    private final RequestTaskService requestTaskService;
    private final RequestService requestService;
    private final WorkflowService workflowService;
    private final UnderlyingAgreementReviewService underlyingAgreementReviewService;
    private final UnderlyingAgreementReviewRequestPeerReviewValidator validator;
    ...
    public RequestTaskPayload process(Long requestTaskId,
        ...
        underlyingAgreementReviewService.requestPeerReview(requestTask, peerReviewer, regulatorReviewer);

        requestService.addActionToRequest(request,
                null,
                CcaRequestActionType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEW_REQUESTED,
                regulatorReviewer);
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_REQUEST_PEER_REVIEW);
    }
}
