...
public class TargetUnitAccountApplyUnderlyingAgreementService {
    ...
    public void execute(Long accountId) {
        ...
        RequestParams requestParams = RequestParams.builder()
                ...
                .requestPayload(initializeUnderlyingAgreementRequestPayload(accountDetails))
    ...
    private UnderlyingAgreementRequestPayload initializeUnderlyingAgreementRequestPayload(TargetUnitAccountDetailsDTO accountDetails) {
