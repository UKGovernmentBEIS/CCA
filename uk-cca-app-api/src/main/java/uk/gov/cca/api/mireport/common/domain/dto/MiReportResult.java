package uk.gov.cca.api.mireport.common.domain.dto;
...
import uk.gov.cca.api.mireport.common.accountsregulatorsitecontacts.AccountAssignedRegulatorSiteContactsMiReportResult;
import uk.gov.cca.api.mireport.common.accountuserscontacts.AccountsUsersContactsMiReportResult;
import uk.gov.cca.api.mireport.common.customreport.CustomMiReportResult;
import uk.gov.cca.api.mireport.common.executedactions.ExecutedRequestActionsMiReportResult;
import uk.gov.cca.api.mireport.common.outstandingrequesttasks.OutstandingRequestTasksMiReportResult;
