...
public class NonComplianceEnforcementResponseNoticePeerReviewDecisionActionHandler implements
        RequestTaskActionHandler<CcaPeerReviewDecisionRequestTaskActionPayload> {

    private final EnforcementResponseNoticePeerReviewService enforcementResponseNoticePeerReviewService;
    ...
    @Override
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType, AppUser appUser, CcaPeerReviewDecisionRequestTaskActionPayload taskActionPayload) {
        ...
        // update task payload
        enforcementResponseNoticePeerReviewService.submitPeerReview(requestTask, taskActionPayload);
        ...
        final CcaPeerReviewDecisionSubmittedRequestActionPayload actionPayload =
                PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                        ...
                        CcaRequestActionPayloadType.NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_PEER_REVIEW_SUBMITTED_PAYLOAD);

        final String actionType = actionPayload.getDecision().getDecision().getType() == PeerReviewDecisionType.AGREE ?
                CcaRequestActionType.NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_PEER_REVIEWER_ACCEPTED :
                CcaRequestActionType.NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.NON_COMPLIANCE_ENFORCEMENT_RESPONSE_NOTICE_SUBMIT_PEER_REVIEW_DECISION);
    }
}
