...
public class PerformanceAccountTemplateProcessingMarkAsCompletedHandler implements JavaDelegate {

	private final PerformanceAccountTemplateProcessingMarkAsCompletedService service;
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		service.markAsCompleted(accountReport);
	}
