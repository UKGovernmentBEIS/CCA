...
public class AdminTerminationSecondReminderDateReachedHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        final Date expirationDate = (Date) execution.getVariable(CcaBpmnProcessConstants.ADMIN_TERMINATION_EXPIRATION_DATE);
