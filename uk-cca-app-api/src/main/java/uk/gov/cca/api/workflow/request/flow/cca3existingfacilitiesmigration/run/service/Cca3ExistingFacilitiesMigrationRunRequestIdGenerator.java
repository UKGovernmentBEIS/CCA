...
@Service
public class Cca3ExistingFacilitiesMigrationRunRequestIdGenerator extends RequestSequenceRequestIdGenerator {

    protected RequestTypeRepository requestTypeRepository;
    private static final String REQUEST_ID_FORMATTER = "%s-%d";

    public Cca3ExistingFacilitiesMigrationRunRequestIdGenerator(RequestSequenceRepository repository, RequestTypeRepository requestTypeRepository) {
        super(repository);
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestType.CCA3_EXISTING_FACILITIES_MIGRATION_RUN);
    }
