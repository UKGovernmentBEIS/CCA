...
public class Cca3SectorAssociationSchemeDataMigrationService extends MigrationBaseService {

	private final FtpProperties ftpProperties;
	private final FtpFileService ftpFileService;
	private final Cca3SectorAssociationSchemeDataMigrationValidationService validationService;
	private final Cca3SectorAssociationSchemeDataMigrationUpdateService updateService;
	...
	public List<String> migrate(String input) {
		...
		// Parse CSV
		List<Cca3SectorAssociationSchemeDataVO> cca3SectorAssociationVOList = CsvUtils
				.convertToModel(fileDTO, Cca3SectorAssociationSchemeDataVO.class, true, errors);
