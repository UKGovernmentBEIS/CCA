...
public class SubsectorAssociationViewController {
    ...
    @GetMapping(path = "/scheme")
    @Operation(summary = "Retrieves the subsector association schemes that correspond to the provided subsector id")
    @ApiResponse(responseCode = "200", description = SwaggerApiInfo.OK,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = SubsectorAssociationSchemesDTO.class))})
