...
public class NonCompliancePenaltyReissueHandlerFlowable implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        enforcementResponseNoticeSubmitService.resetForPenaltyReissue(requestId);
    }
}