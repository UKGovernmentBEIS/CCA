...
import uk.gov.cca.api.user.verifier.service.VerifierUserAcceptInvitationService;
...
public class VerifierUserRegistrationController {
    ...
    @ApiResponse(responseCode = "200", description = SwaggerApiInfo.OK,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = InvitedUserInfoDTO.class))})
    @ApiResponse(responseCode = "400", description = SwaggerApiInfo.ACCEPT_VERIFIER_USER_INVITATION_BAD_REQUEST,
    ...
    @ApiResponse(responseCode = "400", description = SwaggerApiInfo.ENABLE_VERIFIER_USER_FROM_INVITATION_BAD_REQUEST,
            content = {@Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = ErrorResponse.class))})
