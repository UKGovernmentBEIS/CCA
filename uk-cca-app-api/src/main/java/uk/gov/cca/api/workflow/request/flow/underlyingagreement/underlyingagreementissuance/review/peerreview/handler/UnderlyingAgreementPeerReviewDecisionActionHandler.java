...
public class UnderlyingAgreementPeerReviewDecisionActionHandler implements
    ...
    private final UnderlyingAgreementPeerReviewService underlyingAgreementPeerReviewService;
    ...
    public RequestTaskPayload process(Long requestTaskId,
        ...
        final CcaPeerReviewDecisionSubmittedRequestActionPayload actionPayload =
                PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                        ...
                        CcaRequestActionPayloadType.UNDERLYING_AGREEMENT_PEER_REVIEW_SUBMITTED_PAYLOAD);

        final String actionType = actionPayload.getDecision().getDecision().getType() == PeerReviewDecisionType.AGREE ?
                CcaRequestActionType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEWER_ACCEPTED :
                CcaRequestActionType.UNDERLYING_AGREEMENT_APPLICATION_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_SUBMIT_PEER_REVIEW_DECISION);
    }
}
