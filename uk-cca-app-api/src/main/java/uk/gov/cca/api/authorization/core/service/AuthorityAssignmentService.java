...
public class AuthorityAssignmentService {
     ...
     */
    @Transactional
    public Authority createAuthorityWithPermissions(Authority authority, List<String> permissions) {
     ...
     */
    @Transactional
    public Authority updatePendingAuthorityWithNewPermissions(Authority authority, List<String> permissions,
     ...
     */
    @Transactional
    public Authority updateAuthorityWithNewPermissions(Authority authority, List<String> permissions) {
    ...
    private Set<AuthorityPermission> buildNewAuthorityPermissions(Authority authority, List<String> permissions) {
        return permissions
            .stream()
            .map(p ->
                    AuthorityPermission.builder()
