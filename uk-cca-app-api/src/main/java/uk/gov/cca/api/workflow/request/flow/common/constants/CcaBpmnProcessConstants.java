...
public class CcaBpmnProcessConstants {
    ...
    // PAT
    public final String PERFORMANCE_ACCOUNT_TEMPLATE_ACCOUNT_REPORT = "accountReport";
    ...
    public final String BUY_OUT_SURPLUS_ACCOUNT_STATES = "buyOutSurplusAccountStates";
