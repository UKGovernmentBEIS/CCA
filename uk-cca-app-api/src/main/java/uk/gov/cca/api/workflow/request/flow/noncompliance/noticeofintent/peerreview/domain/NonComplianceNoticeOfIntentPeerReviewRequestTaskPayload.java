package uk.gov.cca.api.workflow.request.flow.noncompliance.noticeofintent.peerreview.domain;
...
@AllArgsConstructor
@SuperBuilder
public class NonComplianceNoticeOfIntentPeerReviewRequestTaskPayload extends NonComplianceNoticeOfIntentSubmitRequestTaskPayload implements CcaPeerReviewDecisionRequestTaskPayload {
