...
public interface AccountPerformanceDataReportDetailsMapper {
    ...
    AccountPerformanceDataReportDetailsDTO toPerformanceDataReportDetailsDTO(PerformanceDataEntity entity);
    ...
    PerformanceDataBuyOutSurplusDetailsDTO toPerformanceDataBuyOutSurplusDetailsDTO(PerformanceDataEntity entity);
}
