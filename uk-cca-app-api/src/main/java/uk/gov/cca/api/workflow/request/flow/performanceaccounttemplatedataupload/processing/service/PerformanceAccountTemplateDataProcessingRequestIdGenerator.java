...
@Service
public class PerformanceAccountTemplateDataProcessingRequestIdGenerator extends SectorRequestSequenceRequestIdGenerator {

	public PerformanceAccountTemplateDataProcessingRequestIdGenerator(RequestSequenceRepository repository,
	...
	protected String generateRequestId(Long sequenceNo, RequestParams params) {
		PerformanceAccountTemplateDataProcessingRequestPayload requestPayload = (PerformanceAccountTemplateDataProcessingRequestPayload) params
				.getRequestPayload();
	...
	public List<String> getTypes() {
		return List.of(CcaRequestType.PERFORMANCE_ACCOUNT_TEMPLATE_DATA_PROCESSING);
	}
}