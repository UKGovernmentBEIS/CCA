...
@NamedQuery(
        ...
        query = "select new uk.gov.cca.api.authorization.core.domain.dto.AuthorityRoleDTO("
...
@NamedQuery(
        ...
        query = "select new uk.gov.cca.api.authorization.regulator.domain.RegulatorUserAssignedSubResource("
...
@NamedQuery(
        ...
        query = "select new uk.gov.cca.api.authorization.verifier.domain.VerifierUserAssignedSubResource("
...
@NamedQuery(
        ...
        query = "select new uk.gov.cca.api.authorization.operator.domain.OperatorUserAssignedSubResource("
