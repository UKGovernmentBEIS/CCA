...
public class UnderlyingAgreementVariationPeerReviewDecisionActionHandler implements
    ...
    private final UnderlyingAgreementVariationPeerReviewService underlyingAgreementVariationPeerReviewService;
    ...
    public RequestTaskPayload process(Long requestTaskId,
        ...
        final CcaPeerReviewDecisionSubmittedRequestActionPayload actionPayload =
                PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                        ...
                        CcaRequestActionPayloadType.UNDERLYING_AGREEMENT_VARIATION_PEER_REVIEW_SUBMITTED_PAYLOAD);

        final String actionType = actionPayload.getDecision().getDecision().getType() == PeerReviewDecisionType.AGREE ?
                CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_APPLICATION_PEER_REVIEWER_ACCEPTED :
                CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_APPLICATION_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_VARIATION_SUBMIT_PEER_REVIEW_DECISION);
    }
}
