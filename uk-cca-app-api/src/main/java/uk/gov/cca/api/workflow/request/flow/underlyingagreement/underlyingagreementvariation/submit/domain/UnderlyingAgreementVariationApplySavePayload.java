...
@AllArgsConstructor
@Builder
public class UnderlyingAgreementVariationApplySavePayload {

    @NotNull
    @Valid
    private UnderlyingAgreementVariationApplySaveTargetUnitDetails underlyingAgreementTargetUnitDetails;
