...
public class UnderlyingAgreementCancelActionHandler implements RequestTaskActionHandler<RequestTaskActionEmptyPayload> {
    ...
    public RequestTaskPayload process(Long requestTaskId, String requestTaskActionType, AppUser appUser, RequestTaskActionEmptyPayload payload) {
        ...
        Map<String, Object> bpmnProcessConstants = Stream.of(
        		  new AbstractMap.SimpleEntry<>(CcaBpmnProcessConstants.UNDERLYING_AGREEMENT_OUTCOME, UnderlyingAgreementOutcome.CANCELLED), 
        ...
        if (CcaRequestTaskType.UNDERLYING_AGREEMENT_APPLICATION_REVIEW.equals(requestTask.getType().getCode())) {
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.UNDERLYING_AGREEMENT_CANCEL_APPLICATION);
    }
}
