...
public class UnderlyingAgreementVariationRegulatorLedActivatedAddRequestActionService {
    ...
    public void addRequestAction(final String requestId) {
        ...
        requestService.addActionToRequest(request,
                actionPayload,
                CcaRequestActionType.UNDERLYING_AGREEMENT_VARIATION_REGULATOR_LED_APPLICATION_ACTIVATED,
