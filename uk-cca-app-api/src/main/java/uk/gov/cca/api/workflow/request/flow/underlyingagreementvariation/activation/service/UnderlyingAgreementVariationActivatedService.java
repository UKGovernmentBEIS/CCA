...
import uk.gov.cca.api.workflow.request.flow.underlyingagreementvariation.common.transform.UnderlyingAgreementVariationContainerDeepCloneMapper;
...
public class UnderlyingAgreementVariationActivatedService {
    ...
    private static final AccountReferenceDataMapper ACCOUNT_MAPPER = Mappers.getMapper(AccountReferenceDataMapper.class);
    ...
    public void activateUnderlyingAgreementVariation(String requestId) {
        ...
        underlyingAgreementService.updateUnderlyingAgreement(unaContainerFinal, accountId);
    ...
    private void saveFacilityDataForNewFacilities(final Long accountId, final Set<Facility> facilities, final Map<String, UnderlyingAgreementVariationFacilityReviewDecision> facilitiesReviewGroupDecisions) {
        Map<FacilityItem, LocalDate> chargeStartDateByNewFacilityId = facilities.stream()
        ...
        if (!chargeStartDateByNewFacilityId.isEmpty()) {
            facilityDataUpdateService.createFacilitiesData(buildFacilitiesData(accountId, chargeStartDateByNewFacilityId));
        }
    }
