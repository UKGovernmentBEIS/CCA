...
public class SectorAssociationVOMapper implements RowMapper<SectorAssociationVO> {
    ...
    public SectorAssociationVO mapRow(ResultSet rs, int i) throws SQLException {   	
        ...
        return SectorAssociationVO.builder()
            ...
            .umaDate(rs.getTimestamp("uma_date") != null ? rs.getTimestamp("uma_date").toLocalDateTime().toLocalDate() : null)
