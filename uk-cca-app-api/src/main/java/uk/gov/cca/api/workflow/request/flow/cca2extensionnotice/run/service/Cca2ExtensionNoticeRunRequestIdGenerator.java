...
@Service
public class Cca2ExtensionNoticeRunRequestIdGenerator extends RequestSequenceRequestIdGenerator {

    protected RequestTypeRepository requestTypeRepository;
    private static final String REQUEST_ID_FORMATTER = "%s-%d";

    public Cca2ExtensionNoticeRunRequestIdGenerator(RequestSequenceRepository repository, RequestTypeRepository requestTypeRepository) {
        super(repository);
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestType.CCA2_EXTENSION_NOTICE_RUN);
    }
