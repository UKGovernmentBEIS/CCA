...
public class UnderlyingAgreementVariationSecondReminderDateReachedHandlerFlowable implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) {
		...
		final Date expirationDate =
				(Date) execution.getVariable(CcaBpmnProcessConstants.UNDERLYING_AGREEMENT_VARIATION_EXPIRATION_DATE);
