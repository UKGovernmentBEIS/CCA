...
public class NonComplianceNoticeOfIntentPeerReviewDecisionActionHandler implements
        RequestTaskActionHandler<CcaPeerReviewDecisionRequestTaskActionPayload> {

    private final NoticeOfIntentPeerReviewService noticeOfIntentPeerReviewService;
    ...
    public RequestTaskPayload process(Long requestTaskId,
        ...
        // update task payload
        noticeOfIntentPeerReviewService.submitPeerReview(requestTask, taskActionPayload);
        ...
        final CcaPeerReviewDecisionSubmittedRequestActionPayload actionPayload =
                PEER_REVIEW_MAPPER.toPeerReviewDecisionSubmittedRequestActionPayload(
                        ...
                        CcaRequestActionPayloadType.NON_COMPLIANCE_NOTICE_OF_INTENT_PEER_REVIEW_SUBMITTED_PAYLOAD);

        final String actionType = actionPayload.getDecision().getDecision().getType() == PeerReviewDecisionType.AGREE ?
                CcaRequestActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_PEER_REVIEWER_ACCEPTED :
                CcaRequestActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_PEER_REVIEWER_REJECTED;
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestTaskActionType.NON_COMPLIANCE_NOTICE_OF_INTENT_SUBMIT_PEER_REVIEW_DECISION);
    }
}
