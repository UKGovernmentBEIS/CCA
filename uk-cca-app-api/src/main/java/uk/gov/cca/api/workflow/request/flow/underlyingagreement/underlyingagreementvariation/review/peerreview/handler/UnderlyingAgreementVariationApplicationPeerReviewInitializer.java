...
@Service
public class UnderlyingAgreementVariationApplicationPeerReviewInitializer implements InitializeRequestTaskHandler {
    ...
    public RequestTaskPayload initializePayload(Request request) {
        ...
        return PEER_REVIEW_MAPPER.toUnderlyingAgreementVariationPeerReviewRequestTaskPayload(requestPayload);
    }

    @Override
    public Set<String> getRequestTaskTypes() {
        return Set.of(CcaRequestTaskType.UNDERLYING_AGREEMENT_VARIATION_APPLICATION_PEER_REVIEW);
    }
}
