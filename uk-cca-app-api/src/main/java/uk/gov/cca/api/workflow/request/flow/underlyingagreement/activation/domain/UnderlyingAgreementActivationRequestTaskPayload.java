package uk.gov.cca.api.workflow.request.flow.underlyingagreement.activation.domain;
...
@AllArgsConstructor
@SuperBuilder
public class UnderlyingAgreementActivationRequestTaskPayload extends RequestTaskPayload {
