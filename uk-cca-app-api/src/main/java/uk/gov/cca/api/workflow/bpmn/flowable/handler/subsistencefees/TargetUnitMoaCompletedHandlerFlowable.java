...
public class TargetUnitMoaCompletedHandlerFlowable implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) {
		...
		moaCompletedService.completed(metadata.getParentRequestId(), accountId, MoaType.TARGET_UNIT_MOA, requestId, tuMoaSucceeded, targetUnitMoaErrors, true);
	}		
}
