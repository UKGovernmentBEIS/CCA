...
@Service
public class PerformanceDataProcessingRequestIdGenerator extends SectorRequestSequenceRequestIdGenerator {

    public PerformanceDataProcessingRequestIdGenerator(RequestSequenceRepository repository,
    ...
    protected String generateRequestId(Long sequenceNo, RequestParams params) {
        PerformanceDataProcessingRequestPayload requestPayload =
                (PerformanceDataProcessingRequestPayload) params.getRequestPayload();
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestType.PERFORMANCE_DATA_PROCESSING);
    }
}
