...
@Service("subsectorAssociationAccessHandler")
@RequiredArgsConstructor
public class SubsectorAssociationAccessRuleHandler implements AuthorizationResourceRuleHandler {

    private final AppAuthorizationService appAuthorizationService;
    private final SubsectorAssociationAuthorityInfoProvider subsectorAssociationAuthorityInfoProvider;
    ...
    public void evaluateRules(@Valid Set<AuthorizationRuleScopePermission> authorizationRules, AppUser user, String resourceId) {
        ...
        Long sectorAssociationId = subsectorAssociationAuthorityInfoProvider.getSectorAssociationIdBySubsectorId(Long.parseLong(resourceId));
