...
@Service
public class PerformanceDataFacilityDataUploadRequestIdGenerator extends SectorRequestSequenceRequestIdGenerator {

    public PerformanceDataFacilityDataUploadRequestIdGenerator(RequestSequenceRepository repository,
    ...
    protected String generateRequestId(Long sequenceNo, RequestParams params) {
        PerformanceDataFacilityDataUploadRequestPayload requestPayload =
                (PerformanceDataFacilityDataUploadRequestPayload) params.getRequestPayload();
    ...
    public List<String> getTypes() {
        return List.of(CcaRequestType.PERFORMANCE_DATA_FACILITY_DATA_UPLOAD);
    }
