package uk.gov.cca.api.web.constants;

import lombok.experimental.UtilityClass;

/**
 * Encapsulates domain related to Swagger
 */
@UtilityClass
public final class SwaggerApiInfo {
    ...
    public static final String ACCEPT_AUTHORITY_AND_ENABLE_OPERATOR_USER_FROM_INVITATION_WITH_CREDENTIALS_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
            ...
            "FORM1001 | Form validation failed";
    public static final String ACCEPT_AUTHORITY_AND_ENABLE_SECTOR_USER_FROM_INVITATION_WITH_CREDENTIALS_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
            "EMAIL1001 | The verification link has expired \t\n " +
            "TOKEN1001 | Invalid Token \t\n " +
            "USER1003 | User is already registered with different role \t\n " +
            "AUTHORITY1005 | User status cannot be updated \t\n " +
    ...
    public static final String ACCEPT_SECTOR_INVITATION_TOKEN_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
            "EMAIL1001 | The verification link has expired \t\n " +
            "TOKEN1001 | Invalid Token \t\n " +
            "USER1002 | User is deleted \t\n " +
            "NOTFOUND1001 | Resource not found \t\n " +
    ...
    public static final String AUTHORITY_USER_NOT_RELATED_TO_SECTOR_ASSOCIATION = BAD_REQUEST + ERROR_CODES_HEADER +
            "CCAAUTHORITY1001 | User is not related to sector association";
    ...
    public static final String ACCEPT_AUTHORITY_AND_ENABLE_OPERATOR_USER_FROM_INVITATION_WOUT_CREDENTIALS_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        ...
        "AUTHORITY1016 | Authority already exists for a different role type than operator \t\n " +
        "FORM1001 | Form validation failed";
    public static final String ACCEPT_AUTHORITY_AND_ENABLE_SECTOR_USER_FROM_INVITATION_WOUT_CREDENTIALS_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        "EMAIL1001 | The verification link has expired \t\n " +
        "TOKEN1001 | Invalid Token \t\n " +
        "USER1003 | User is already registered with different role \t\n " +
        "AUTHORITY1005 | User status cannot be updated \t\n " +
    ...
    public static final String SET_CREDENTIALS_TO_REGISTERED_OPERATOR_USER_FROM_INVITATION_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        ...
        "TOKEN1001 | Invalid Token \t\n " +
        "FORM1001 | Form validation failed";
    public static final String SET_CREDENTIALS_TO_REGISTERED_SECTOR_USER_FROM_INVITATION_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        "USER1003 | User is already registered with different role \t\n " +
        "USER1004 | User status is not valid \t\n " +
        "AUTHORITY1005 | User status cannot be updated \t\n " +
        "CCAAUTHORITY1003 | Authority already exists for a different role type than sector user \t\n " +
        ...
        "TOKEN1001 | Invalid Token \t\n " +
        "FORM1001 | Form validation failed";
    public static final String ENABLE_SECTOR_USER_FROM_INVITATION_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        "USER1004 | User status is not valid \t\n " +
        "EMAIL1001 | The verification link has expired \t\n " +
        "TOKEN1001 | Invalid Token \t\n " +
        "FORM1001 | Form validation failed";
    ...
    public static final String UPDATE_SECTOR_ASSOCIATION_SECTOR_DETAILS_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        "FORM1001 | Form validation failed \t\n " +
        "SECTOR1001 | Sector association details cannot be updated";
    public static final String UPDATE_SECTOR_ASSOCIATION_SECTOR_CONTACT_BAD_REQUEST = BAD_REQUEST + ERROR_CODES_HEADER +
        "FORM1001 | Form validation failed \t\n " +
        "SECTOR1002 | Sector association contact cannot be updated";
