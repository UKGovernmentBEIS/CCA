...
public class Cca3SectorAssociationSchemeDataMigrationValidationService {

	private final DataValidator<Cca3SectorAssociationSchemeDataVO> dataValidator;
	private final SectorAssociationQueryService sectorAssociationQueryService;

	public void validate(List<Cca3SectorAssociationSchemeDataVO> sectorAssociationInputs, List<String> errors) {
		...
		for(Cca3SectorAssociationSchemeDataVO vo : sectorAssociationInputs) {
	...
	private void validateSectorSubsectorUniqueness(List<Cca3SectorAssociationSchemeDataVO> sectorAssociationInputs, List<String> errors) {
	...
	private void validateSubsectorsSectorDefinitionUniqueness(List<Cca3SectorAssociationSchemeDataVO> sectorAssociationInputs, List<String> errors) {
		...
		Map<String, Set<String>> subsectorSectorDefinitions = sectorAssociationInputs.stream()
				...
				.collect(Collectors.groupingBy(
						Cca3SectorAssociationSchemeDataVO::getSectorAcronym,
						Collectors.mapping(Cca3SectorAssociationSchemeDataVO::getSectorDefinition, Collectors.toSet())
				));
	...
	private void validateSectorAndSubsectorExistence(Cca3SectorAssociationSchemeDataVO vo, List<String> errors) {
