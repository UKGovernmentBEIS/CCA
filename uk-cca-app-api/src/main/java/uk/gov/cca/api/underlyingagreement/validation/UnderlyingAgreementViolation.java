...
public class UnderlyingAgreementViolation extends BusinessViolation {
    ...
    public enum UnderlyingAgreementViolationMessage {
        ...
        INVALID_PREVIOUS_FACILITY_ID("The Underlying Agreement contains a Previous Facility which does not exist or has been already excluded"),
        INVALID_PREVIOUS_FACILITY_ID_CCA2_ONLY("The Underlying Agreement contains a Previous Facility which participates only in the CCA2 scheme"),
        ...
        INVALID_FACILITY_PARTICIPATING_SCHEME_VERSIONS_AFTER_SCHEME_END_DATE("The Underlying Agreement contains a Facility which participates in a terminated scheme"),
