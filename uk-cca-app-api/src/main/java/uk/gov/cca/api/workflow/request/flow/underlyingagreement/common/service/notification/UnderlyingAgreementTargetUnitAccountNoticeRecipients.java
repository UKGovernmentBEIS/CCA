...
public class UnderlyingAgreementTargetUnitAccountNoticeRecipients {
    ...
    private static final UnderlyingAgreementTargetUnitDetailsMapper UNA_TARGET_UNIT_DETAILS_MAPPER = Mappers.getMapper(UnderlyingAgreementTargetUnitDetailsMapper.class);
    ...
    public List<NoticeRecipientDTO> getNoticeRecipients(final Long accountId,
        ...
        defaultNoticeRecipients.add(UNA_TARGET_UNIT_DETAILS_MAPPER.toResponsiblePersonNoticeRecipientDTO(responsiblePerson));
